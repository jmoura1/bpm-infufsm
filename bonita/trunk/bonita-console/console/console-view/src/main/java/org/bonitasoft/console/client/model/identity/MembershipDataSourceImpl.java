 ...
 * 
 */
public class MembershipDataSourceImpl extends DefaultFilteredDataSourceImpl<BonitaUUID, MembershipItem, SimpleFilter> implements MembershipDataSource {

  public MembershipDataSourceImpl(MessageDataSource aMessageDataSource) {
    super(new MembershipData(), new SimpleSelection<BonitaUUID>(), aMessageDataSource);
