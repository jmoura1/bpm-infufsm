...
public class ConsoleFormPanel extends SimplePanel implements FiresFormEvents,
    FormPanelImplHost {
  /**
  ...
  public interface SubmitCompleteHandler extends EventHandler {
     ...
     */
    void onSubmitComplete(ConsoleFormPanel.SubmitCompleteEvent event);
  }
  ...
  public static class SubmitEvent extends GwtEvent<SubmitHandler> {
    ...
    @Override
    public final Type<ConsoleFormPanel.SubmitHandler> getAssociatedType() {
      return TYPE;
    }
    ...
    @Override
    protected void dispatch(ConsoleFormPanel.SubmitHandler handler) {
  ...
  public interface SubmitHandler extends EventHandler {
     ...
     * @param event the event
     */
    void onSubmit(ConsoleFormPanel.SubmitEvent event);
  }
   ...
   */
  public static ConsoleFormPanel wrap(Element element) {
    // Assert that the element is attached.
    assert Document.get().getBody().isOrHasChild(element);

    ConsoleFormPanel consoleFormPanel = new ConsoleFormPanel(element);

    // Mark it attached and remember it for cleanup.
    consoleFormPanel.onAttach();
    RootPanel.detachOnWindowClose(consoleFormPanel);

    return consoleFormPanel;
  }
   ...
   */
  public static ConsoleFormPanel wrap(Element element, boolean createIFrame) {
    // Assert that the element is attached.
    assert Document.get().getBody().isOrHasChild(element);

    ConsoleFormPanel consoleFormPanel = new ConsoleFormPanel(element, createIFrame);
   ...
   *          be replaced
   */
  public ConsoleFormPanel(String target) {
   ...
   */
  protected ConsoleFormPanel(Element element) {
    this(element, false);
  }
  ...
  private boolean fireSubmitEvent() {
    ConsoleFormPanel.SubmitEvent event = new ConsoleFormPanel.SubmitEvent();
    fireEvent(event);
