 ...
 */
public class TextAreaEditor extends I18NComposite implements HasValue<String>, ClickHandler {
  ...
  protected TextArea myTextEditor;
   ...
   * Default constructor.
   */
  public TextAreaEditor(String aLabel, String aValue, boolean allowHtml) {
    myOuterPanel = new FlowPanel();
    myFieldLabel = new Label();
    if(aLabel!=null) {
      myFieldLabel.setText(aLabel);
    }
    myOuterPanel.setStylePrimaryName("bos_textarea_editor");
