...
public class ApplicationConfig implements Serializable {
     ...
     * @param mandatorySymbol
     * @param mandatoryStyle
     */
    public ApplicationConfig(final String applicationLabel, final HtmlTemplate applicationLayout, final String mandatorySymbol, final String mandatoryLabel, final String mandatoryStyle, final String userXPURL) {
