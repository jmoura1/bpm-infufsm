...
/**
 * Object containing the elements required to build the Level1 of the form application (process template)
 * 
...
public class HtmlTemplate implements Serializable {
    ...
    public void setDynamicMessage(final String dynamicMessage) {
