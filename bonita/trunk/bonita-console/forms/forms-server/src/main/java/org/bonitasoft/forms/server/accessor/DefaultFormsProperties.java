...
public class DefaultFormsProperties {
     ...
     */
    protected DefaultFormsProperties(){
        defaultProperties = new Properties();
        // Read properties file.
        InputStream inputStream = null;
        try {
        	final File propertiesFile = new File(PropertiesFactory.getTenancyProperties().getDomainFormConfFolder(), FORM_DEFAULT_CONFIG_FILE_NAME);
    ...
    public int getMaxWigdetPerPage() {
        ...
        try {
            ...
            LOGGER.log(Level.INFO, "the max number of widgets per page is undefined or incorrectly defined. Using the default value : " + DEFAULT_MAX_WIDGET_PER_PAGE);
    ...
    public int getMaxProcessesInCache() {
        ...
        try {
            ...
            LOGGER.log(Level.INFO, "the max number of process form definifion in cache is undefined or incorrectly defined. Using the default value : " + DEFAULT_CACHE_MAX_PROCESS_ENTRIES);
    ...
    public int getMaxLanguagesInCache() {
        ...
        try {
            ...
            LOGGER.log(Level.INFO, "the max number of languages of process form definifion in cache is undefined or incorrectly defined. Using the default value : " + DEFAULT_CACHE_MAX_LANGUAGE_ENTRIES);
    ...
    public String getFormServiceProviderImpl() {
        ...
        if (formServiceProviderImpl == null) {
            String defaultImpl = FormServiceProviderImpl.class.getName();
            LOGGER.log(Level.INFO, "the form service provider Implementation is undefined or incorrectly defined. Using the default implementation : " + defaultImpl);
            return defaultImpl;
        }
