...
public interface IFormDefinitionAPI {
     ...
     */
    HtmlTemplate getWelcomePage(Map<String, Object> context) throws FileNotFoundException, InvalidFormTemplateException, InvalidFormDefinitionException,ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;
     ...
     * @param formID the formID of the application form
     * @param context Map containing the URL parameters
     ...
     * @param formID the formID of the specific form
     * @param context Map containing the URL parameters
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    String getFormPermissions(String formID, Map<String, Object> context) throws ApplicationFormDefinitionNotFoundException, InvalidFormDefinitionException, FormServiceProviderNotFoundException ;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    String getNextForm(String formID, Map<String, Object> context) throws ApplicationFormDefinitionNotFoundException, InvalidFormDefinitionException, FormServiceProviderNotFoundException ;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    String getFormPageLayout(String formID, String pageID, Map<String, Object> context) throws ApplicationFormDefinitionNotFoundException, InvalidFormDefinitionException, FormServiceProviderNotFoundException ;
     ...
     * @param includeApplicationTemplate indicate whether the Level 1 HTM template should be returned or not within the ApplicationConfig object
     * @return a {@link ApplicationConfig} object containing the elements required to build the level1 (application template)
     * @throws InvalidFormDefinitionException 
     * @throws FormServiceProviderNotFoundException 
     */
    ApplicationConfig getApplicationConfig(Map<String, Object> context, String formID, boolean includeApplicationTemplate) throws InvalidFormDefinitionException, FormServiceProviderNotFoundException;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    String getFormFirstPage(String formID, Map<String, Object> context) throws FormNotFoundException, InvalidFormDefinitionException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    List<TransientData> getFormTransientData(String formID, Map<String, Object> context) throws InvalidFormDefinitionException, FormNotFoundException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    FormPage getFormPage(String formID, String pageID, Map<String, Object> context) throws InvalidFormDefinitionException, FormNotFoundException, FileNotFoundException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException ;
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    HtmlTemplate getFormConfirmationLayout(String formID, Map<String, Object> context) throws InvalidFormDefinitionException, FormNotFoundException, FileNotFoundException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;

    /**
     * Retrieve a list of actions to be executed at form submission
     * @param formID the form ID
     * @param pageIds list of pages for which the actions are required
     * @param context Map containing the URL parameters
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    List<FormAction> getFormActions(String formID, List<String> pageIds, Map<String, Object> context) throws InvalidFormDefinitionException, FormNotFoundException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;
    
    /**
     * Parse a page layout and insert some step attributes in it
     * @param pageTemplate the page layout object
     * @param stepAttributes the map of step attributes
     * @param locale the user's locale
     */
    void applicationAttributes(HtmlTemplate pageTemplate, Map<String, String> stepAttributes, Locale locale);
    
    /**
     * Retrieve and initialize the transient data for a form
     * @param transientData the List of transient data
     * @param locale the user's locale
     * @param context Map containing the URL parameters
     ...
     */
    Map<String, Object> getTransientDataContext(List<TransientData> transientData, Locale userLocale, Map<String, Object> context) throws FormNotFoundException, FormServiceProviderNotFoundException, ClassNotFoundException;

    /**
     * Set the application definition deploy date
     * @param applicationDefinitionDate the Date that the application was deployed
     */
     ...
     * @throws FormServiceProviderNotFoundException 
     */
    HtmlTemplate getApplicationErrorLayout(Map<String, Object> context) throws InvalidFormDefinitionException, FileNotFoundException, ApplicationFormDefinitionNotFoundException, FormServiceProviderNotFoundException;
