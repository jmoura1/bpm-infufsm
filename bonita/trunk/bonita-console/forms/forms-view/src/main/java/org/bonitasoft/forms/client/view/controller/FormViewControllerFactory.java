...
public class FormViewControllerFactory {
    ...
    public static FormPagesViewController getFormPagesViewController(final String formID, Map<String, Object> contextMap, final FormPage firstPage, final HTMLPanel applicationHTMLPanel, final User user, String elementId) {
