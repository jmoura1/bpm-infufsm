...
public class FormButtonWidget extends Composite implements HasClickHandlers, ClickHandler {
    ...
    protected void createWidget(final FormWidget formButtonData) {
        ...
        if (isLabelButton) {
            ...
            if (formButtonData.getStyle() != null && formButtonData.getStyle().length() > 0) {
                flowPanel.addStyleName(formButtonData.getStyle());
            }
            ...
            if (formButtonData.getStyle() != null && formButtonData.getStyle().length() > 0) {
                flowPanel.addStyleName(formButtonData.getStyle());
                String css = "bonita_form_button " + formButtonData.getStyle();
