 ...
 * This interface deals with the static part of the data managed by the wokflow.<br><br>
 *
...
public interface QueryDefinitionAPI {
   ...
   */
  BusinessArchive getBusinessArchive(ProcessDefinitionUUID processDefinitionUUID)
   ...
   * @throws ProcessNotFoundException if no process exists with the given processDefinition UUID.
   * @throws BonitaInternalException if another exception occurs.
   */
   ...
   * @param processDefinitionUUID the processDefinition UUID.
   * @param dataFieldName the dataField name.
...
//  DataFieldDefinition getDataField(DataFieldUUID dataFieldDefinitionUUID);
   ...
   * @throws ProcessNotFoundException if the process with the given process name does not exist.
   */
  Set<AttachmentDefinition> getAttachmentDefinitions(ProcessDefinitionUUID processUUID)
  throws ProcessNotFoundException;
   ...
   */
  Set<LightProcessDefinition> getLightProcesses(Set<ProcessDefinitionUUID> processUUIDs) throws ProcessNotFoundException;
   ...
   * @return an ordered list of LightProcessDefinition
   */
  List<LightProcessDefinition> getLightProcesses(Set<ProcessDefinitionUUID> processUUIDs, int fromIndex, int pageSize, ProcessDefinitionCriterion pagingCriterion) throws ProcessNotFoundException;
   ...
   * @return
   */
  List<LightProcessDefinition> getAllLightProcessesExcept(Set<ProcessDefinitionUUID> processUUIDs, int fromIndex, int pageSize);
   ...
   * @return
   */
  List<LightProcessDefinition> getAllLightProcessesExcept(Set<ProcessDefinitionUUID> processUUIDs, int fromIndex, int pageSize, ProcessDefinitionCriterion pagingCriterion);
