...
public class WebGetProcessInstancesNumberWithStartedBy implements Command<Integer> {
  ...
  private final String username;
	 ...
	 * @param userId
	 */
	public WebGetProcessInstancesNumberWithStartedBy(String userId, Set<String> roleUUIDs, Set<String> groupUUIDs, Set<String> membershipUUIDs, String username, boolean searchInHistory) {
		this.userId = userId;
