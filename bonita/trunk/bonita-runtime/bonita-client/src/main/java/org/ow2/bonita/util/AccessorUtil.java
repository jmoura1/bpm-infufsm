 ...
 *(possible values are "Standard", "AutoDetect", "EJB2" and "EJB3").<br>
 */
public final class AccessorUtil {
   ...
   * @return the interface IdentityAPI.
   */
  // public static IdentityAPI getIdentityAPI(final String
  // queryList) {
  // return getAPIAccessor().getIdentityAPI(queryList);
  // }
