 ...
 * <ul>
 * <li><b><code>&lt;boolean .../&gt;</code>, <code>&lt;true /&gt;</code> and
 * <code>&lt;false/&gt;</code></b>: see {@link BooleanBinding}</li>
 ...
 * 
 * <p>
 * Once a parser is created, bindings can be added, overwritten and removed to
 * customize that parser instance.
 * </p>
 * 
 ...
 * 
 * <p>
 * This element can have an attribute "type", which specifies name of the
 * argument's type.
 * </p>
 * <p>
 * This element contains <b>one</b> child element that defines a
 * {@link Descriptor}. This descriptor specifies the value to give to the
 * argument.
 * </p>
 * 
 * <h4>Example</h4>
 ...
 * </pre>
 * 
 * The following Xml declaration will create an object 's' of class 'String'
 * (see {@link ObjectDescriptor}). This object is created by invoking
 * <code>Hello.sayHello</code> with the value <code>world</code> as a parameter.
 * 
 * <pre>
 * &lt;objects&gt;
 ...
 * 
 * <p>
 * The initialization method can be defined with the <code>init</code>
 * attribute. For more details on how initialization works, see section
 * 'Initialization' of {@link WireContext}.
 * </p>
 * 
...
public class WireParser extends Parser {
  ...
  public static WireDefinition parseXmlString(String xmlString) {
     Parse parse = getInstance().createParse().setString(xmlString).execute();
  ...
  /**
   * This method builds the WireDefinition from the DOM tree. This methods
   * parses all child nodes of the documentElement that correspond to a
   * Descriptor definition.
   * 
   * @param documentElement
   *          the root element of the document
   * @param parse
   *          Parse object that contains all information for the current parse
   *          operation.
   * @return an instance of WireDefinition containing the resulting
   *         WireDefinition.
  ...
  /**
   * This method parses an arbitrary element in the document based on the
   * bindings in the given category. This method calls the
   * {@link Parser#parseElement(Element, Parse, String)} method to build the
   * resulting object. If the resulting object is a subclass of
   * {@link AbstractDescriptor}, the related fields are initialized.
   * 
   * @param element
   ...
   *          operation.
   * @param category
   *          is the category in which the tagName should be resolved to an
   *          ElementHandler. If category is null, all the categories will be
  ...
  /**
   * Parses the list of arguments of a method. This method creates a list of
   * {@link ArgDescriptor} from the given list of DOM elements
   * 
   * @param argElements
    ...
    if (argElements != null) {
      ...
      for (Element argElement : argElements) {
        ...
        if (descriptorElement == null) {
          parse
              .addProblem("arg must contain exactly one descriptor element out of "
                  + bindings.getTagNames(CATEGORY_DESCRIPTOR)
                  + " as contents:"
                  + XmlUtil.toString((Element) argElement.getParentNode()));
        } else {
          Descriptor descriptor = (Descriptor) parseElement(descriptorElement,
              parse, CATEGORY_DESCRIPTOR);
  ...
  static {
    ...
    Enumeration<URL> enumeration = ReflectUtil.getResources(null,
