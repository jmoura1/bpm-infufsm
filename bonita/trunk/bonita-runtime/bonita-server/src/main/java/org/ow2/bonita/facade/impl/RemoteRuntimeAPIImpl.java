...
public class RemoteRuntimeAPIImpl extends AbstractRemoteRuntimeAPIImpl implements RemoteRuntimeAPI{
  ...
  public void deleteAllProcessInstances(final Collection<ProcessDefinitionUUID> processUUIDs, final Map<String, String> options)
  throws ProcessNotFoundException, UndeletableInstanceException {
    getAPI(options).deleteAllProcessInstances(processUUIDs);
  }

  public void deleteProcessInstances(Collection<ProcessInstanceUUID> instanceUUIDs, final Map<String, String> options)
  throws InstanceNotFoundException, UndeletableInstanceException {
    getAPI(options).deleteProcessInstances(instanceUUIDs);
  }

  public void cancelProcessInstances(Collection<ProcessInstanceUUID> instanceUUIDs, final Map<String, String> options)
  ...
  public ProcessInstanceUUID instantiateProcess(final ProcessDefinitionUUID processUUID, final Map<String, Object> variables,
      Collection<InitialAttachment> attachments, final Map<String, String> options) throws ProcessNotFoundException, VariableNotFoundException {
