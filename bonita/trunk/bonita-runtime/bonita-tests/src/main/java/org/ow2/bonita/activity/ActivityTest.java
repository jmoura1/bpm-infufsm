...
public class ActivityTest extends APITestCase {
  ...
  public void testHugeDescription() throws Exception {
    ...
    ProcessDefinition definition = ProcessBuilder.createProcess("desc", "2.1")
    .addSystemTask("sys")
  ...
  private void atomicExecutTask(ProcessInstanceUUID instanceUUID, String taskName) throws Exception {
    Set<LightActivityInstance> activityInstances = getQueryRuntimeAPI().getLightActivityInstances(instanceUUID, taskName);
