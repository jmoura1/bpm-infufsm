...
public class QueryRuntimeAPITest extends APITestCase {
  ...
  public void testGetTaskCandidates() throws Exception {
    ...
    .addHuman("b")
    .addHuman("c")
    .addHumanTask("t1", getLogin(), "a", "b")
    .addHumanTask("t2", getLogin(), "b", "c")
    .done();
  ...
  public void testDynamicLabelsAndDescriptions() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("myProcess", "1.0")
    .addStringData("processVar", "pValue")
    .addSystemTask("a")
    .addDynamicDescription("${true}")
    .addDynamicLabel("${true}")
    .addSystemTask("b")
    .addDynamicDescription("${\"xx\" + processVar}")
    .addDynamicLabel("${\"xx\" + processVar}")
    .addSystemTask("c")
    .addDynamicDescription("${\"xx\" + localVar}")
    .addDynamicLabel("${\"xx\" + localVar}")
    .addStringData("localVar", "lValue1")
    .addSystemTask("d")
    .addDynamicDescription("${\"xx\" + processVar + localVar}")
    .addDynamicLabel("${\"xx\" + processVar + localVar}")
    .addStringData("localVar", "lValue2")
    .addTransition("a", "b")
    .addTransition("b", "c")
    .addTransition("c", "d")
    .done();
  ...
  public void testQuerySplitting() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("my", "22.33")
    .addSystemTask("t1")
    .done();
  ...
  public void testGetNumberOf() throws Exception {
    ...
    assertEquals(InstanceState.FINISHED, getQueryRuntimeAPI().getProcessInstance(t.getProcessInstanceUUID()).getInstanceState());
    assertEquals(InstanceState.FINISHED, getQueryRuntimeAPI().getProcessInstance(t.getRootInstanceUUID()).getInstanceState());

    tasks = getQueryRuntimeAPI().getTaskList(ActivityState.READY);
    assertEquals(1, tasks.size());
    t = tasks.iterator().next();

    assertEquals(InstanceState.STARTED, getQueryRuntimeAPI().getProcessInstance(t.getProcessInstanceUUID()).getInstanceState());
    assertEquals(InstanceState.STARTED, getQueryRuntimeAPI().getProcessInstance(t.getRootInstanceUUID()).getInstanceState());
  ...
  public void testGetActivitiesFromRootInstance() throws Exception {
    ...
    .addTransition("s", "t1")
    .addTransition("aSubProcess", "t1")
    .done();

    ProcessDefinition subProcess = ProcessBuilder.createProcess("aSubProcess", "1.0")
    .addHuman(getLogin())
    .addSystemTask("subs")
    .addHumanTask("subt1", getLogin())
    .addSystemTask("subs2")
    .addTransition("subs", "subt1")
    .addTransition("subt1", "subs2")
    .done();
    ...
    List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstancesFromRoot(parentInstanceUUID);
    List<LightTaskInstance> tasks = getQueryRuntimeAPI().getLightTaskInstancesFromRoot(parentInstanceUUID);
  ...
  public void testRootInstanceUUID() throws BonitaException {
    ...
    final ProcessInstance child1ProcessInstance = getQueryRuntimeAPI().getProcessInstances(subProcess.getUUID()).iterator().next();
    assertEquals(1, getQueryRuntimeAPI().getProcessInstances(subSubProcess.getUUID()).size());
    final ProcessInstance child2ProcessInstance = getQueryRuntimeAPI().getProcessInstances(subSubProcess.getUUID()).iterator().next();
  ...
  public void testGetProcessInstancesPaging() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("p", "5.0")
    .addHuman(getLogin())
    ...
    List<ProcessInstanceUUID> filter = Misc.subList(ProcessInstanceUUID.class, instanceUUIDs, 0, 7);
  ...
  public void testGetProcessInstancesPagingJournalVsHistory() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("theProcess", "1.0").addHuman(getLogin()).addHumanTask("t", getLogin()).done();
    ...
    assertEquals(initialInstanceCount - 2 * pageSize, getQueryRuntimeAPI().getLightProcessInstances(2 * pageSize, pageSize).size());
  ...
  public void testGetProcessInstancesPagingJournalVsHistory2() throws Exception {
    ...
    List<ProcessInstanceUUID> expectedInstanceUUIDs = new ArrayList<ProcessInstanceUUID>();
  ...
  public void testGetLightProcessInstancesPagingOrderByEndedDateAsc() throws Exception {
    ...
    for (int i = 0 ; i < instanceNumber ; i++) {
    	ProcessInstanceUUID instanceUUID = instanceUUIDs.get(i);
  ...
  private void checkInstanceListContent(int fromIndex, int pageSize, int expectedResults, 
  		List<ProcessInstanceUUID> instanceUUIDs, List<ProcessInstanceUUID> filter, ProcessInstanceCriterion pagingCriterion) {
    ...
    if (filter == null) {
    	...
    	Set<ProcessInstanceUUID> setFilter = new HashSet<ProcessInstanceUUID>(filter);    	
    ...
    final List<ProcessInstanceUUID> expectedInstances = Misc.subList(ProcessInstanceUUID.class, instancesToUse, fromIndex, toIndex);
    final String errorMsg = "Checking retrieved instances order. Expected: " + expectedInstances + " but was " + retrivedInstances;    
    assertEquals(errorMsg, expectedInstances, retrivedInstances);
  }

  public void testGetProcessInstances() throws BonitaException {
    ProcessDefinition processDef = getManagementAPI().deploy(getBusinessArchiveFromXpdl(this.getClass().getResource("queryRuntime.xpdl")));
    ProcessDefinitionUUID processUUID = processDef.getUUID();
  ...
  public void testGetUserInstances() throws BonitaException, LoginException {
    ...
    .addGroup("initiator")
    .addGroupResolver(ProcessInitiatorRoleResolver.class.getName())
    .addHumanTask("t1", userId)
    .addHumanTask("t2", "initiator")
    .addHumanTask("t3", "wrongUser")
    .addHumanTask("t4", "james")
    .done();
    ...
    loginAs("john", "bpm");
    ProcessInstanceUUID instance2 = getRuntimeAPI().instantiateProcess(processUUID);
  ...
  public void testGetUserInstancesAssigned() throws BonitaException, LoginException {
    ...
    .addInputParameter("users", "jack")
    .addHumanTask("t", "users")
    .done();
  ...
  public void testGetUserInstancesCandidates() throws BonitaException, LoginException {
    ...
    .addGroup("users")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "jack,john,james")
    .addHumanTask("t", "users")
    .done();
    process = getManagementAPI().deploy(getBusinessArchive(process, null, UserListRoleResolver.class));
    ProcessDefinitionUUID processUUID = process.getUUID();
  ...
  private void checkInstances(String user, int number, ProcessInstanceUUID... uuids) throws LoginException {
    loginAs(user, "bpm");
  ...
  public void testGetTaskListWithActivityState() throws BonitaException {
    ...
    .addGroup("userList")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "unknownUser1, unknownUser2, " + getLogin())
    .addGroup("wrongUserList")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "unknownUser1, unknownUser2")
    .addHumanTask("t1", "initiator")
    .addHumanTask("t2", "userList")
    .addHumanTask("t3", "wrongUserList")
    .addHumanTask("end", "initiator")
    .addJoinType(JoinType.AND)
    .addTransition("t1_end", "t1", "end")
    .addTransition("t2_end", "t2", "end")
    .addTransition("t3_end", "t3", "end")
    .done();

    process = getManagementAPI().deploy(getBusinessArchive(process, null, ProcessInitiatorRoleResolver.class, UserListRoleResolver.class));
  ...
  private boolean contains(Collection<TaskInstance> tasks, String activityName) {
    return getTask(tasks, activityName) != null;
  }

  private TaskInstance getTask(Collection<TaskInstance> tasks, String activityName) {
  ...
  public void testGetTaskListWithStateCollection() throws BonitaException, LoginException {
    ...
    loginAs("admin", "bpm");
    ProcessInstanceUUID instanceUUID1 = getRuntimeAPI().instantiateProcess(processUUID);
    Collection<TaskInstance> taskList = getQueryRuntimeAPI().getTaskList(instanceUUID1, taskStates);
  ...
  public void testCanExecuteActivity() throws BonitaException {
    ...
    .addGroup("initiator")
    .addGroupResolver(ProcessInitiatorRoleResolver.class.getName())
    .addGroup("unknownUser")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "unknownUser")
    .addGroup("wrongUserList")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "unknownUser1, unknownUser2")
    .addGroup("correctUserList")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("users", "unknownUser1, unknownUser2, " + getLogin())
    .addSystemTask("t1")
    .addHumanTask("t2", "initiator")
    .addHumanTask("t3", "unknownUser")
    .addHumanTask("t4", "wrongUserList")
    .addHumanTask("t5", "correctUserList")
    .addTransition("t1_t2", "t1", "t2")
    .addTransition("t1_t3", "t1", "t3")
    .addTransition("t1_t4", "t1", "t4")
    .addTransition("t1_t5", "t1", "t5")
    .done();

    process = getManagementAPI().deploy(getBusinessArchive(process, null, UserListRoleResolver.class, ProcessInitiatorRoleResolver.class));
  ...
  public void testGetProcessInstancesWithTaskState() throws BonitaException {
    ProcessDefinition processDef = getManagementAPI().deploy(getBusinessArchiveFromXpdl(this.getClass().getResource("queryRuntime-states.xpdl")));
    ProcessDefinitionUUID processUUID = processDef.getUUID();
    ...
    todolist = getQueryRuntimeAPI().getTaskList(instances.iterator().next().getProcessInstanceUUID(), ActivityState.READY);
    assertEquals("todolist must contain 1 element", 1, todolist.size());
    ...
    //instance1.A=FINISHED && instance1.B=FINISHED (auto activity) && instance1.C=READY && instance2.A=READY

    assertEquals("ActiivtyA of instance1 must be FINISHED", ActivityState.FINISHED, getQueryRuntimeAPI().getTask(instance1A.getUUID()).getState());
    ...
    TaskInstance instance1C = todolist.iterator().next();
    ...
    //instance1.A=FINISHED && instance1.B=FINISHED && instance1.C=FINISHED && instance2.A=READY
  ...
  public void testGetLightTaskInstance() throws Exception {
    ProcessDefinition definition =
      ProcessBuilder.createProcess("kakykytkaks", null)
      .addHuman(getLogin())
      .addHumanTask("yo", getLogin())
      .done();
    ...
    ActivityInstanceUUID taskUUID = getQueryRuntimeAPI().getOneTask(instanceUUID, ActivityState.READY);

    LightTaskInstance task = getQueryRuntimeAPI().getLightTaskInstance(taskUUID);
    assertNotNull(task);
  ...
  public void testGetProcessInstancesWithInstanceStates() throws Exception {
    ProcessDefinition definition =
      ProcessBuilder.createProcess("test_getinstances_with_state", null)
      .addHuman(getLogin())
    ...
    definition = getManagementAPI().deploy(getBusinessArchive(definition));
    ProcessInstanceUUID instanceUUID = getRuntimeAPI().instantiateProcess(definition.getUUID());
    ProcessInstanceUUID instanceUUID2 = getRuntimeAPI().instantiateProcess(definition.getUUID());

    Set<InstanceState> instanceStates = new HashSet<InstanceState>();
  ...
  public void testGetTasks() throws Exception {
    ProcessDefinition definition =
      ...
      .addGroup("humans")
      .addGroupResolver(UserListRoleResolver.class.getName())
      .addInputParameter("users", "john, admin, james")
      .addSystemTask("start")
      .addHumanTask("first", "humans")
      .addHumanTask("second", "humans")
      .addHumanTask("third", "humans")
      .addHumanTask("fourth", "humans")
      .addTransition("start", "first")
      .addTransition("first", "second")
      .addTransition("second", "third")
      .addTransition("third", "fourth")
      .done();
  ...
  public void testGetLightParentUserInstancesPagingOrderByEndedDateAsc() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    for (int i = 0 ; i < numberOfInstances ; i++) { 
    	ProcessInstance instance = getQueryRuntimeAPI().getProcessInstance(instanceUUIDs.get(i));
    	Set<ProcessInstanceUUID> childrenUUIDs = instance.getChildrenInstanceUUID();
  ...
  private void checkParentUserInstanceListContent(int fromIndex, int pageSize, int expectedResults,
			List<ProcessInstanceUUID> instanceUUIDs, ProcessInstanceCriterion pagingCriterion) {
  	List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentUserInstances(fromIndex,
				pageSize, pagingCriterion);
    checkListContent(fromIndex, pageSize, expectedResults, instanceUUIDs,
				instances);
	}
  
  private void checkParentUserInstanceExceptListContent(int fromIndex, int pageSize, int expectedResults,
			List<ProcessInstanceUUID> instanceUUIDs, Set<ProcessDefinitionUUID> processUUIDs, ProcessInstanceCriterion pagingCriterion) {
  	List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentUserInstancesExcept(fromIndex,
  ...
  private void checkParentProcessInstancesWithActiveUserListContent(String userId, int fromIndex, int pageSize, int expectedResults,
			List<ProcessInstanceUUID> instanceUUIDs, ProcessInstanceCriterion pagingCriterion) {
  	List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser(
  			userId, fromIndex, pageSize, pagingCriterion);
    checkListContent(fromIndex, pageSize, expectedResults, instanceUUIDs,
				instances);
	}

	private void checkListContent(int fromIndex, int pageSize,
			int expectedNbofResults, List<ProcessInstanceUUID> instanceUUIDs,
			List<LightProcessInstance> instances) {
    ...
    final List<ProcessInstanceUUID> expectedInstances = Misc.subList(ProcessInstanceUUID.class, instanceUUIDs, fromIndex, toIndex);    
  ...
  public void testDynamicExecutionSummary() throws Exception {
    ...
    .addDynamicExecutionSummary("a${2+2}")
    .addSystemTask("b")
    .addDynamicExecutionSummary("${3+3}")
    .addTransition("a", "b")
    .done();
  ...
  public void testGetXMLData() throws Exception {
    ...
    ProcessDefinition process = ProcessBuilder.createProcess("myProcess", "1.0")
    .addXMLData("xmlProcessVar", "<node att=\"attValue\"><child>childValue</child></node>")
    .addHuman(getLogin())
    .addHumanTask("task", getLogin())
    .addXMLData("xmlActivityVar", "<node att=\"attValue\"><child>childValue</child></node>")
    .done();
    ...
    ActivityInstanceUUID activityUUID = getQueryRuntimeAPI().getOneTask(instanceUUID, ActivityState.READY);
    /// process
    // test node
    Object value = null;
  ...
  public void testGetXMLDataUsingScriptAsInitialValue() throws Exception {
    ...
    ProcessDefinition process = ProcessBuilder.createProcess("xmlDefaultValueProcess", "1.0")
      .addHuman(getLogin())
      .addXMLDataFromScript("globalXmlData", stb.toString())
      .addHumanTask("step1", getLogin())
        .addXMLDataFromScript("localXmlData", stb.toString())
      .done();
    ...
    assertTrue("value should be a node", value instanceof Node);
    // test text
    value = getQueryRuntimeAPI().getProcessInstanceVariable(instanceUUID, "globalXmlData" + separator + "/node/child/text()");
    assertEquals("childValue", value);
    // test attribute
  ...
  public void testGetProcessInstanceVariables() throws Exception {
    ProcessDefinition definition =
      ProcessBuilder.createProcess("var", "95.2")
      .addStringData("text")
      .addIntegerData("number", 83)
      .addHuman(getLogin())
  ...
  public void testGetLightActivitiesPaging() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.DEFAULT);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.DEFAULT);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.DEFAULT);
  	assertEquals(1, activities.size());
  ...
  public void testGetLightActivitiesPaginOrderByLastUpdateAsc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.LAST_UPDATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.LAST_UPDATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.LAST_UPDATE_ASC);
  	assertEquals(1, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  ...
  public void testGetLightActivitiesPagingOrderByStartedDateAsc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.STARTED_DATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.STARTED_DATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.STARTED_DATE_ASC);
  	assertEquals(1, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
	...
	public void testGetLightActivitiesPagingOrderByEndedDateAsc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.ENDED_DATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.ENDED_DATE_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.ENDED_DATE_ASC);
  	assertEquals(1, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  ...
  public void testGetLightActivitiesPagingOrderByNameAsc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.NAME_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.NAME_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step4", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.NAME_ASC);
  	assertEquals(1, activities.size());
  ...
  public void testGetLightActivitiesPagingOrderByPriorityAsc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.PRIORITY_ASC);
  	assertEquals(2, activities.size());
  	assertEquals("step2", activities.get(0).getActivityName());
  	assertEquals("step1", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 4, ActivityInstanceCriterion.PRIORITY_ASC);
  	assertEquals(1, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());    	
  ...
  public void testGetLightActivitiesPaginOrderByLastUpdateDesc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.LAST_UPDATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.LAST_UPDATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.LAST_UPDATE_DESC);
  	assertEquals(1, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  ...
  public void testGetLightActivitiesPagingOrderByStartedDateDesc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.STARTED_DATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.STARTED_DATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.STARTED_DATE_DESC);
  	assertEquals(1, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
	...
	public void testGetLightActivitiesPagingOrderByEndedDateDesc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.ENDED_DATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step5", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.ENDED_DATE_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step4", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.ENDED_DATE_DESC);
  	assertEquals(1, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  ...
  public void testGetLightActivitiesPagingOrderByNameDesc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.NAME_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step5", activities.get(0).getActivityName());
  	assertEquals("step4", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 2, ActivityInstanceCriterion.NAME_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step2", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 4, 2, ActivityInstanceCriterion.NAME_DESC);
  	assertEquals(1, activities.size());
  	assertEquals("step1", activities.get(0).getActivityName());
  ...
  public void testGetLightActivitiesPagingOrderByPriorityDesc() throws BonitaException{
  	...
  	List<LightActivityInstance> activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 0, 2, ActivityInstanceCriterion.PRIORITY_DESC);
  	assertEquals(2, activities.size());
  	assertEquals("step3", activities.get(0).getActivityName());
  	assertEquals("step1", activities.get(1).getActivityName());
  	
  	activities = getQueryRuntimeAPI().getLightActivityInstances(
  			instanceUUID, 2, 4, ActivityInstanceCriterion.PRIORITY_DESC);
  	assertEquals(1, activities.size());
  	assertEquals("step2", activities.get(0).getActivityName());    	
  ...
  private ProcessDefinition getProcess(){
  	...
  	ProcessDefinition definition = ProcessBuilder.createProcess("process", "1.0")
  	.addStringData("text")
  	.addHuman(getLogin())
  	.addHuman("john")
  	.addHumanTask("step1", getLogin(), "john")
  		.addStringData("text1")
  		.addActivityExecutingTime(tomorrow.getTime() - now.getTime())
  	.addSystemTask("step2")
  		.addStringData("text2")
  	.addSystemTask("step3")
  		.addStringData("text3")
  ...
  private ProcessDefinition getProcess2(){
  	Date now = new Date();
  	Date afterTomorrow = DateUtil.getNextDay(DateUtil.getNextDay(now));
  	
  	ProcessDefinition definition = ProcessBuilder.createProcess("process2", "1.0")
  	.addStringData("text")
  	.addHuman(getLogin())
  	.addHuman("john")
  	.addHumanTask("step1", getLogin(), "john")
  		.addStringData("text1")
  		.addActivityExecutingTime(afterTomorrow.getTime() - now.getTime())
  	.done();
  ...
  private ProcessDefinition getProcessWithPriorities(){
  	ProcessDefinition definition = ProcessBuilder.createProcess("processWithPriorities", "1.0")
  	.addStringData("text")
  	.addSystemTask("step1")
  ...
  private void checkParentInstanceListContent(int fromIndex, int pageSize, int expectedResults,
			List<ProcessInstanceUUID> instanceUUIDs, ProcessInstanceCriterion pagingCriterion) {
  	List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromIndex,
				pageSize, pagingCriterion);
    checkListContent(fromIndex, pageSize, expectedResults, instanceUUIDs,
				instances);
	}
  ...
  public void testGetLightParentProcessInstancesOrderByInstanceUUIDDesc() throws Exception {
	...
	private ProcessDefinition getSuprocess() {
      ...
      ProcessBuilder.createProcess("aSubProcess", "1.0")
      .addHuman(getLogin())
      .addHumanTask("h", getLogin())
      .done();
		return subProcess;
	}
	...
	private ProcessDefinition getProcessWithASubprocess() {
      ...
      ProcessBuilder.createProcess("pProcess", "1.0")
      .addStringData("text")
      .addSubProcess("aSubProcess", "aSubProcess")
      .done();
		return process;
	...
	public void testGetLightParentUserInstancesExceptOrderByLastUpdateAsc() throws Exception {
		...
		List<ProcessInstanceUUID> instanceUUIDsP1 = new ArrayList<ProcessInstanceUUID>();
		...
		List<ProcessInstanceUUID> instanceUUIDsP2 = new ArrayList<ProcessInstanceUUID>();
		instanciateProcesses(processUUID2, numberOfProcess2, instanceUUIDsP2);		
		
		Set<ProcessDefinitionUUID> exceptP1 = new HashSet<ProcessDefinitionUUID>();
		exceptP1.add(processUUID1);
		
		Set<ProcessDefinitionUUID> exceptP2 = new HashSet<ProcessDefinitionUUID>();
		exceptP2.add(processUUID2);
		
		Collections.reverse(instanceUUIDsP1);
		
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);
	...
	public void testGetLightParentUserInstancesExceptOrderByStartedDateAsc() throws Exception {
		...
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.STARTED_DATE_ASC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.STARTED_DATE_ASC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);
	...
	public void testGetLightParentUserInstancesExceptOrderByEndedDateAsc() throws Exception{
		...
		for (ProcessInstanceUUID processInstanceUUID : instanceUUIDsP1) {
		...
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.ENDED_DATE_ASC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.ENDED_DATE_ASC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);
	...
	public void testGetLightParentUserInstancesExceptOrderByInstanceNumberAsc() throws Exception{
		...
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
	...
	public void testGetLightParentUserInstancesExceptOrderByInstanceUUIDAsc() throws Exception{
		...
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
	...
	public void testGetLightParentUserInstancesExceptOrderByLastUpdateDesc() throws Exception {
		...
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);
	...
	public void testGetLightParentUserInstancesExceptOrderByStartedDateDesc() throws Exception {
		...
		Collections.reverse(instanceUUIDsP1);
		Collections.reverse(instanceUUIDsP2);
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.STARTED_DATE_DESC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.STARTED_DATE_DESC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);
	...
	public void testGetLightParentUserInstancesExceptOrderByEndedDateDesc() throws Exception{
		...
		Collections.reverse(instanceUUIDsP1);
		Collections.reverse(instanceUUIDsP2);		
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.ENDED_DATE_DESC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.ENDED_DATE_DESC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.ENDED_DATE_DESC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.ENDED_DATE_DESC);
	...
	public void testGetLightParentUserInstancesExceptOrderByInstanceNumberDesc() throws Exception{
		...
		Collections.reverse(instanceUUIDsP1);
		Collections.reverse(instanceUUIDsP2);		
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
	...
	public void testGetLightParentUserInstancesExceptOrderByInstanceUUIDDesc() throws Exception{
		...
		Collections.reverse(instanceUUIDsP1);
		Collections.reverse(instanceUUIDsP2);
		checkParentUserInstanceExceptListContent(0, 5, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
		checkParentUserInstanceExceptListContent(5, 10, 5, instanceUUIDsP1, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
		checkParentUserInstanceExceptListContent(0, 3, 3, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
		checkParentUserInstanceExceptListContent(3, 5, 2, instanceUUIDsP2, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
	...
	public void testGetLightParentUserInstancesFromProcessUUIDsOrderByLastUpdateAsc() throws Exception {
		...
		Set<ProcessDefinitionUUID> fromP1 = new HashSet<ProcessDefinitionUUID>();
		fromP1.add(processUUID1);
		
		Set<ProcessDefinitionUUID> fromP2 = new HashSet<ProcessDefinitionUUID>();
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByLastUpdateAsc() throws Exception {
		...
		Collections.reverse(instanceUUIDs);
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.LAST_UPDATE_ASC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByStartedDateAsc() throws Exception {
		...
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.STARTED_DATE_ASC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.STARTED_DATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByEndedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser(
				"john", 5, 10,ProcessInstanceCriterion.ENDED_DATE_ASC);
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByInstanceNumberAsc() throws Exception {
		...
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByInstanceUUIDAsc() throws Exception {
		...
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByLastUpdateDesc() throws Exception {
		...
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.LAST_UPDATE_DESC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByStartedDateDesc() throws Exception {
		...
		Collections.reverse(instanceUUIDs);
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.STARTED_DATE_DESC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.STARTED_DATE_DESC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByEndedDateDesc() throws Exception {
		...
		assertEquals(5, retrievedInstances.size());
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser(
				"john", 5, 10,ProcessInstanceCriterion.ENDED_DATE_DESC);
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByInstanceNumberDesc() throws Exception {
		...
		Collections.reverse(instanceUUIDs);
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserOrderByInstanceUUIDDesc() throws Exception {
		...
		checkParentProcessInstancesWithActiveUserListContent("john", 0, 5, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
		checkParentProcessInstancesWithActiveUserListContent("john", 5, 10, 5, instanceUUIDs, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByLastUpdateAsc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByStartedDateAsc() throws Exception{
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByEndedDateAsc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(3, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.ENDED_DATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByInstanceNumberAsc() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByInstanceUUIDAsc() throws Exception{
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByLastUpdateDesc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByStartedDateDesc() throws Exception{
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByEndedDateDesc() throws Exception {
		...
		//there is no ended date, the instance is not finished
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(3, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(2, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByInstanceNumberDesc() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserFromProcessUUIDsOrderByInstanceUUIDDesc() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByLastUpdateAsc() throws Exception {
		...
		//except process2
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		//except process1
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 3,
				5, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
		
		//except process1 and process2
		Set<ProcessDefinitionUUID> exceptP1AndP2 = new HashSet<ProcessDefinitionUUID>();
		exceptP1AndP2.add(processUUID1);
		exceptP1AndP2.add(processUUID2);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP1AndP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByStartedDateAsc() throws Exception {
	 ...
	 //except process2
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		//except process1
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 3,
				5, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP1AndP2, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		assertEquals(0, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByEndedDateAsc() throws Exception {
		...
		//there is no ended date, the instance is not finished
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());		
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(3, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 3,
				5, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(2, retrievedInstances.size());
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP1AndP2, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(0, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByInstanceNumberAsc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 3,
				5, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP1AndP2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		assertEquals(0, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByInstanceUUIDAsc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 3,
				5, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP1AndP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		assertEquals(0, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByLastUpdateDesc() throws Exception {
		...
		//except process2
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByStartedDateDesc() throws Exception {
	 ...
	 //except process2
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByEndedDateDesc() throws Exception {
		...
		//there is no ended date, the instance is not finished
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByInstanceNumberDesc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserExceptOrderByInstanceUUIDDesc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserExcept("john", 5,
				10, exceptP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByLastUpdateAsc() throws Exception {
		...
		List<ProcessInstanceUUID> expectedUUIDsOrder = getListCopy(instanceUUIDs);		
		//last update asc
		List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
				"john", 0, 5, ProcessInstanceCriterion.LAST_UPDATE_ASC);
		checkListContent(0, 5, 5, expectedUUIDsOrder, instances);
		
		instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
				"john", 5, 10, ProcessInstanceCriterion.LAST_UPDATE_ASC);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByStartedDateAsc() throws Exception {
    ...
    //Started date asc
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.STARTED_DATE_ASC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.STARTED_DATE_ASC);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByInstanceNumberAsc() throws Exception {
    ...
    //instance number asc
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByInstanceUUIDAsc() throws Exception {
    ...
    Collections.sort(instanceUUIDs, new ProcessInstanceUUIDComparator());
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);   
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByLastUpdateDesc() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.LAST_UPDATE_DESC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.LAST_UPDATE_DESC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByStartedDateDesc() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.STARTED_DATE_DESC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.STARTED_DATE_DESC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByInstanceNumberDesc() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByInstanceUUIDDesc() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserPagingOrderByDefault() throws Exception {
    ...
    Collections.reverse(instanceUUIDs);
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 0, 5, ProcessInstanceCriterion.DEFAULT);
    checkListContent(0, 5, 5, instanceUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser(
        "john", 5, 10, ProcessInstanceCriterion.DEFAULT);
    checkListContent(5, 10, 5, instanceUUIDs, instances);
    
    getManagementAPI().deleteProcess(processUUID);  
  }
	
	public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByLastUpdateAsc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		Set<ProcessDefinitionUUID> fromP1AndP2 = new HashSet<ProcessDefinitionUUID>();
		...
		Collections.reverse(instanceUUIDsP1);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
				5, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 5,
				10, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
		
		//last update asc from p2
		Collections.reverse(instanceUUIDsP2);
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
				3, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 3,
				5, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
		
		//last update asc from p1 and p2
		List<ProcessInstanceUUID> expectedOrder = new ArrayList<ProcessInstanceUUID>();		
		expectedOrder.addAll(instanceUUIDsP1);
		expectedOrder.addAll(instanceUUIDsP2);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
				8, fromP1AndP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
				20, fromP1AndP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByStartedDateAsc() throws Exception {
	  ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    List<ProcessInstanceUUID> instanceUUIDsP1AndP2 = new ArrayList<ProcessInstanceUUID>();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.STARTED_DATE_ASC);   
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.STARTED_DATE_ASC);    
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByEndedDateAsc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    List<ProcessInstanceUUID> instanceUUIDsP2AndP1 = new ArrayList<ProcessInstanceUUID>();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.ENDED_DATE_ASC);   
    checkListContent(0, 8, 8, instanceUUIDsP2AndP1, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.ENDED_DATE_ASC);    
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByInstanceNumberAsc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByInstanceUUIDAsc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);    
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);   
    checkListContent(8, 20, 7, instanceUUIDsP1AndP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByLastUpdateDesc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);   
    checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.LAST_UPDATE_DESC);    
    checkListContent(8, 20, 7, expectedOrder, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByStartedDateDesc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.STARTED_DATE_DESC);    
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.STARTED_DATE_DESC);   
    checkListContent(8, 20, 7, instanceUUIDsP1AndP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByEndedDateDesc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.ENDED_DATE_DESC);    
    checkListContent(0, 8, 8, instanceUUIDsP2AndP1, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.ENDED_DATE_DESC);   
    checkListContent(8, 20, 7, instanceUUIDsP2AndP1, retrievedInstances); 
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByInstanceNumberDesc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByInstanceUUIDDesc() throws Exception {
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    Collections.reverse(instanceUUIDsP1AndP2);   
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);   
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);    
    checkListContent(8, 20, 7, instanceUUIDsP1AndP2, retrievedInstances);     
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserFromProcessUUIDsPagingOderByDefault() throws Exception {
    ...
    //default from p1   
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        5, fromP1, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 5,
        10, fromP1, ProcessInstanceCriterion.DEFAULT);    
    checkListContent(5, 10, 5, instanceUUIDsP1, retrievedInstances);
    
    //default from p2
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        3, fromP2, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 3,
        5, fromP2, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, fromP1AndP2, ProcessInstanceCriterion.DEFAULT);    
    checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 8,
        20, fromP1AndP2, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(8, 20, 7, expectedOrder, retrievedInstances);
    
    //empty list
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUser("john", 0,
        8, new HashSet<ProcessDefinitionUUID>(), ProcessInstanceCriterion.DEFAULT);
    assertEquals(0, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByLastUpdateAsc() throws Exception{
		...
		Set<ProcessDefinitionUUID> exceptP1 = Collections.singleton(processUUID1);
		Set<ProcessDefinitionUUID> exceptP2 = Collections.singleton(processUUID2);		
		
		//**** last update
		//last update asc except p1
		List<ProcessInstanceUUID> expectedOrder = getListCopy(instanceUUIDsP2);
		Collections.reverse(expectedOrder);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
				5, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
				10, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		...
		Collections.reverse(expectedOrder);
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
				5, exceptP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, expectedOrder, retrievedInstances);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
				8, null, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
				20, null, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);   
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.STARTED_DATE_ASC);    
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.STARTED_DATE_ASC);   
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);   
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.ENDED_DATE_ASC);    
    checkListContent(0, 8, 8, instanceUUIDsP2AndP1, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.ENDED_DATE_ASC);   
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByInstanceNumberAsc() throws Exception{
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);    
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByProcessUUIDAsc() throws Exception{
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);    
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    ...
    Collections.sort(instanceUUIDsP1AndP2, new ProcessInstanceUUIDComparator());
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.INSTANCE_UUID_ASC);   
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.INSTANCE_UUID_ASC);    
    checkListContent(8, 20, 12, instanceUUIDsP1AndP2, retrievedInstances);    
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByLastUpdateDesc() throws Exception{
    ...
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);    
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);   
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    ...
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.LAST_UPDATE_DESC);    
    checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.LAST_UPDATE_DESC);   
    checkListContent(8, 20, 12, expectedOrder, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByStartedDateDesc() throws Exception{
    ...
    Collections.reverse(instanceUUIDsP2);
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);   
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);    
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    ...
    Collections.reverse(instanceUUIDsP1AndP2);   
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.STARTED_DATE_DESC);   
    checkListContent(0, 8, 8, instanceUUIDsP1AndP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.STARTED_DATE_DESC);    
    checkListContent(8, 20, 12, instanceUUIDsP1AndP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByEndedDateDesc() throws Exception{
    ...
    Collections.reverse(instanceUUIDsP2);
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.ENDED_DATE_DESC);   
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.ENDED_DATE_DESC);    
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    ...
    Collections.reverse(instanceUUIDsP2AndP1);   
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.ENDED_DATE_DESC);   
    checkListContent(0, 8, 8, instanceUUIDsP2AndP1, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.ENDED_DATE_DESC);    
    checkListContent(8, 20, 12, instanceUUIDsP2AndP1, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByInstanceNumberDesc() throws Exception{
    ProcessDefinition process1 = getProcess();
    ProcessDefinition process2 = getProcess2();
    ...
    Collections.reverse(instanceUUIDsP2);
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);    
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);   
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByProcessUUIDDesc() throws Exception{
    ...
    Collections.reverse(instanceUUIDsP2);
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);    
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);   
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
  ...
  public void testGetLightParentProcessInstancesWithInvolvedUserExceptPagingOrderByProcessDefault() throws Exception{
    ...
    Set<ProcessDefinitionUUID> excpetP1AndP2 = new HashSet<ProcessDefinitionUUID>();
    ...
    Collections.reverse(instanceUUIDsP2);
    List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP1, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(0, 5, 5, instanceUUIDsP2, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 5,
        10, exceptP1, ProcessInstanceCriterion.DEFAULT);    
    checkListContent(5, 10, 5, instanceUUIDsP2, retrievedInstances);
    
    //default except p2       
    Collections.reverse(instanceUUIDsP1);   
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        5, exceptP2, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(0, 5, 5, instanceUUIDsP1, retrievedInstances);
  ...
  //last update asc except null
    ...
    Collections.reverse(expectedOrder);   
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, null, ProcessInstanceCriterion.DEFAULT);   
    checkListContent(0, 8, 8, expectedOrder, retrievedInstances);
    
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 8,
        20, null, ProcessInstanceCriterion.DEFAULT);    
    checkListContent(8, 20, 12, expectedOrder, retrievedInstances);
    
    //expect p1 and p2
    retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithInvolvedUserExcept("john", 0,
        8, excpetP1AndP2, ProcessInstanceCriterion.DEFAULT);
    assertEquals(0, retrievedInstances.size());   
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateFromProcessUUIDsPaging() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, fromP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(5, 10, 5, expectedOrder, retrievedInstances);
		
		//last update desc from p1		
		Collections.reverse(expectedOrder);
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  0,
				5, fromP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 5, 5, expectedOrder, retrievedInstances);
		...
		Collections.reverse(expectedOrder);
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 2,  0,
				3, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 2,  3,
				5, fromP2, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		...
		//default from p1		
		expectedOrder = getListCopy(instanceUUIDsP1);		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 3,  0,
				5, fromP1, ProcessInstanceCriterion.DEFAULT);		
		checkListContent(0, 5, 5, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 3,  5,
				10, fromP1, ProcessInstanceCriterion.DEFAULT);		
		checkListContent(5, 10, 5, expectedOrder, retrievedInstances);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 3,  3,
				5, fromP2, ProcessInstanceCriterion.DEFAULT);		
		checkListContent(3, 5, 2, expectedOrder, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  3,
				5, fromP2, ProcessInstanceCriterion.DEFAULT);		
		assertEquals(0, retrievedInstances.size());
	...
	private void updateInstanceVariable(List<ProcessInstanceUUID> instanceUUIDs,
			String variableId, Object variableValue, boolean reverseUpdateOrder)
	...
	private void instanciateProcesses(ProcessDefinitionUUID processUUID,
			final int numberOfInstances, List<ProcessInstanceUUID> instanceUUIDs)
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByLastUpdateAsc() throws Exception {
		ProcessDefinition process1 = getProcess();
		process1 = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process1));
		ProcessDefinitionUUID processUUID1 = process1.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByLastUpdateDesc()  throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByStartedDateAsc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByStartedDateDesc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByEndedDateAsc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
	...
	//the end date is empty
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByEndedDateDesc() throws Exception{
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByInstanceNumberAsc() throws Exception{
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByInstanceNumberDesc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByInstanceUUIDAsc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateOrderByInstanceUUIDDesc() throws Exception {
		ProcessDefinition process = getProcess();
		process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
		ProcessDefinitionUUID processUUID = process.getUUID();		
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1, 0,
				5, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDate("john", 1,  5,
				10, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(5, 10, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByLastUpdateAsc() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		Collections.reverse(instanceUUIDsP2);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  3,
				5, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(3, 5, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByLastUpdateDesc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByStartedDateAsc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByStartedDateDesc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByEndedDateAsc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByEndedDateDesc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(3, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByNbAsc() throws Exception{
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByNbDesc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByUUIDAsc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
	...
	public void testGetLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExceptOrderByUUIDDesc() throws Exception {
		ProcessDefinition process1 = getProcess();
		ProcessDefinition process2 = getProcess2();
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithActiveUserAndActivityInstanceExpectedEndDateExcept("john", 2,  0,
				3, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByLastUpdateAsc() throws Exception {
		...
		Date today = new Date();
		for (int i = 0; i < numberOfProcess; i++) {
			TaskInstance task = getQueryRuntimeAPI().getTasks(instanceUUIDs.get(i)).iterator().next();
			assertEquals("step1", task.getActivityName());
			ChangeExpectedEndDateActitityInstance dayBeforeYesterday = new ChangeExpectedEndDateActitityInstance(task.getUUID(), DateUtil.backTo(today, 2));
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByStartedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByStartedDateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByEndedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByEndedDateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByNbAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByNbDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByUUIDAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksOrderByUUIDDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByLastUpdateAsc() throws Exception {
		...
		Set<ProcessDefinitionUUID> fromP = Collections.singleton(processUUID);
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByLastUpdateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByStartedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByStartedDateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByEndedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByEndedDateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.ENDED_DATE_DESC);		
		assertEquals(5, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByNbAsc() throws Exception {
		...
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithOverdueTasks("john", 0, 5, fromP, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasks("john", 5, 11, fromP, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(5, 11, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByNbDesc() throws Exception {
		...
		Collections.reverse(instanceUUIDs);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithOverdueTasks("john", 0, 5, fromP, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksFromUUIDsOrderByUUIDDesc() throws Exception {
		...
		Collections.reverse(instanceUUIDs);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithOverdueTasks("john", 0, 5, fromP, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(0, 5, 5, instanceUUIDs, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByLastUpdateAsc() throws Exception {
		...
		for (int i = 0; i < numberOfProcess1; i++) {
			TaskInstance task = getQueryRuntimeAPI().getTasks(instanceUUIDsP1.get(i)).iterator().next();
			ChangeExpectedEndDateActitityInstance dayBeforeYesterday = new ChangeExpectedEndDateActitityInstance(task.getUUID(), DateUtil.backTo(today, 2));
			getCommandAPI().execute(dayBeforeYesterday);
		}
		...
		for (int i = 0; i < numberOfProcess2; i++) {
			TaskInstance task = getQueryRuntimeAPI().getTasks(instanceUUIDsP2.get(i)).iterator().next();
			ChangeExpectedEndDateActitityInstance dayBeforeYesterday = new ChangeExpectedEndDateActitityInstance(task.getUUID(), DateUtil.backTo(today, 2));
			getCommandAPI().execute(dayBeforeYesterday);
		}
		...
		Collections.reverse(instanceUUIDsP2);
		List<LightProcessInstance> retrievedInstances = getQueryRuntimeAPI()
		.getLightParentProcessInstancesWithOverdueTasksExcept("john", 0,
				3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
		checkListContent(0, 3, 3, instanceUUIDsP2, retrievedInstances);
		
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_ASC);		
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByLastUpdateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.LAST_UPDATE_DESC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByStartedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.STARTED_DATE_ASC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByStartedDateDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.STARTED_DATE_DESC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByEndedDateAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.ENDED_DATE_ASC);		
		assertEquals(2, retrievedInstances.size());
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByNbAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByNbDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByUUIDAsc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_ASC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
	...
	public void testGetLightParentProcessInstancesWithOverdueTasksExceptOrderByUUIDDesc() throws Exception {
		...
		retrievedInstances = getQueryRuntimeAPI().getLightParentProcessInstancesWithOverdueTasksExcept(
				"john", 3, 3, exceptP1, ProcessInstanceCriterion.INSTANCE_UUID_DESC);		
		checkListContent(3, 3, 2, instanceUUIDsP2, retrievedInstances);
  ...
  private <T> List<T> getListCopy(List<T> instanceUUIDs) {
    List<T> listCopy = new ArrayList<T>();
    listCopy.addAll(instanceUUIDs);   
    return listCopy;
  }
  
  private void createProcessesWithaSubProcess(int numberOfProcess,
      List<ProcessDefinitionUUID> parentProcessUUIDs,
      List<ProcessDefinitionUUID> subProcessUUIDs) throws DeploymentException {
    for (int i = 0; i < numberOfProcess; i++) {
      ProcessDefinition process =
        ProcessBuilder.createProcess("pProcess" + i, "1.0")
        .addStringData("text")
        .addSubProcess("aSubProcess", "aSubProcess" + i)
        .done();    
      
      ProcessDefinition subProcess =
        ProcessBuilder.createProcess("aSubProcess" + i, "1.0")
        .addHuman(getLogin())
        .addHumanTask("h", getLogin())
        .done();          
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByDefault() throws Exception {
    ...
    List<ProcessDefinitionUUID> parentProcessUUIDs = new ArrayList<ProcessDefinitionUUID>();
    List<ProcessDefinitionUUID> subProcessUUIDs = new ArrayList<ProcessDefinitionUUID>();
    createProcessesWithaSubProcess(numberOfProcess, parentProcessUUIDs,
        subProcessUUIDs);
    ...
    List<ProcessInstanceUUID> usedInstancesUUIDs = instanceUUIDs.subList(0, 4); 
    
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.DEFAULT);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.DEFAULT);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByLastUpdateAsc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.LAST_UPDATE_ASC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.LAST_UPDATE_ASC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByLastUpdateDesc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.LAST_UPDATE_DESC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.LAST_UPDATE_DESC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByStartedDateAsc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.STARTED_DATE_ASC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.STARTED_DATE_ASC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByStartedDateDesc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.STARTED_DATE_DESC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.STARTED_DATE_DESC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByEndedDateAsc() throws Exception {
    ...
    for (ProcessInstanceUUID processInstanceUUID : instanceUUIDs) {
      ProcessInstance instance = getQueryRuntimeAPI().getProcessInstance(processInstanceUUID);
      Set<ProcessInstanceUUID> childrenUUIDs = instance.getChildrenInstanceUUID();
      assertEquals(1, childrenUUIDs.size());
      executeTask(childrenUUIDs.iterator().next(), "h");
      Thread.sleep(3);
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.ENDED_DATE_ASC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.ENDED_DATE_ASC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByEndedDateDesc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.ENDED_DATE_DESC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.ENDED_DATE_DESC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByInstanceNumberAsc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
    ...
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.INSTANCE_NUMBER_ASC);
    assertEquals(2, instances.size());
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByInstanceNumberDesc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
    assertEquals(2, instances.size());
    assertEquals(2, instances.get(0).getNb());
    assertEquals(2, instances.get(1).getNb());
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.INSTANCE_NUMBER_DESC);
    assertEquals(2, instances.size());
    assertEquals(1, instances.get(0).getNb());
    assertEquals(1, instances.get(1).getNb());
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByInstanceUUIDAsc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.INSTANCE_UUID_ASC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesFromProcessUUIDsOrderByInstanceUUIDDesc() throws Exception {
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 0,
        2, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstances(fromProcess, 2,
        3, ProcessInstanceCriterion.INSTANCE_UUID_DESC);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testGetLightParentProcessInstancesExceptOrderByDefault() throws Exception {
    ...
    Set<ProcessDefinitionUUID> exceptProcesses = new HashSet<ProcessDefinitionUUID>();
    ...
    List<LightProcessInstance> instances = getQueryRuntimeAPI().getLightParentProcessInstancesExcept(exceptProcesses, 0,
        2, ProcessInstanceCriterion.DEFAULT);
    checkListContent(0, 2, 2, usedInstancesUUIDs, instances);
    
    instances = getQueryRuntimeAPI().getLightParentProcessInstancesExcept(exceptProcesses, 2,
        3, ProcessInstanceCriterion.DEFAULT);
    checkListContent(2, 3, 2, usedInstancesUUIDs, instances);
  ...
  public void testCallingGetProcessIsntanceDontChangeLastUpdate() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("tcgpidclu", "1.0")
                                .addAttachment("att2")
                                .done();
    process = getManagementAPI().deploy(BusinessArchiveFactory.getBusinessArchive(process));
