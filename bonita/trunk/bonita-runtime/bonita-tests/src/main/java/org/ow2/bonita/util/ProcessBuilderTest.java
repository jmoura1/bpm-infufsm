...
public class ProcessBuilderTest extends APITestCase {
  ...
  private String processName = "WebSale";
  private String processDescription = "The websale example";

  public void testCreateSimpleProcess() {
    ProcessBuilder builder =
      ProcessBuilder.createProcess(processName, null);
    ProcessDefinition process = builder.done();
  ...
  public void testProcessWithOneActivity() {
    ProcessBuilder builder =
      ProcessBuilder.createProcess(processName, null).addSystemTask("t");
    ProcessDefinition process = builder.done();
    Assert.assertEquals(processName, process.getName());
    Assert.assertNull(process.getDescription());
  }
  ...
  public void testCreateProcessWithProcessAttributes() {
    ProcessDefinition process =
      ProcessBuilder.createProcess(processName, "2.0")
      .addDescription(processDescription)
      .addStringData("siteName")
      .done();
  ...
  public void testProcessDescription() throws IOException, ClassNotFoundException, BonitaException {
    ProcessDefinition processClient = 
      ProcessBuilder.createProcess("myProcess", "1.0")
    ...
    ProcessDefinition process = getManagementAPI().deploy(getBusinessArchive(processClient));
    final ProcessDefinitionUUID processUUID = process.getUUID();

    ProcessDefinition processDef = getQueryDefinitionAPI().getProcess(processUUID);
  ...
  public void testXpdl() throws ClassNotFoundException, IOException, DeploymentException, ProcessNotFoundException, UndeletableProcessException, UndeletableInstanceException {
    final URL xpdlUrl = this.getClass().getResource("manyHooks.xpdl");
    ProcessDefinition process = getManagementAPI().deploy(getBusinessArchiveFromXpdl(xpdlUrl, IncrementHook.class));
  ...
  public void testAutoSubProcess() throws IOException, ClassNotFoundException, BonitaException {
    ProcessDefinition subProcessClient = 
      ProcessBuilder.createProcess("subflow", "1.0")
      .addSystemTask("subTask")
      .done();

    ProcessDefinition processClient = 
      ProcessBuilder.createProcess("main", "1.0")
      .addSubProcess("sub", "subflow")
      .done();

    ProcessDefinition subProcess = getManagementAPI().deploy(getBusinessArchive(subProcessClient));
    ...
    ProcessInstance parentInstance = getQueryRuntimeAPI().getProcessInstance(instanceUUID);
    assertEquals(InstanceState.FINISHED, parentInstance.getInstanceState());
    ProcessInstanceUUID childUUID = parentInstance.getChildrenInstanceUUID().iterator().next();
    ProcessInstance childInstance = getQueryRuntimeAPI().getProcessInstance(childUUID);
  ...
  public void testSubProcess() throws IOException, ClassNotFoundException, BonitaException {
    ...
    ProcessDefinition processClient = 
      ProcessBuilder.createProcess("main", "1.0")
      .addSystemTask("a1")
      .addSubProcess("a2", "subflow")
      .addSystemTask("a3")
      .addTransition("a1_a2", "a1", "a2")
      .addTransition("a2", "a3")
      .done();
  ...
  public void testCreateProcessWithactivityAndDataSettingAtTheEnd() {
    ProcessDefinition def = ProcessBuilder.createProcess("activities", "10.1")
    .addHumanTask("first", "john")
    .addStringData("data1")
    .addHuman("john")
    .addBooleanData("data2")
    .done();

    Set<ActivityDefinition> activities = def.getActivities();
    Assert.assertEquals(1, activities.size());
    ActivityDefinition activity = activities.iterator().next();
  ...
  public void testDescription() {
    ProcessDefinition def = ProcessBuilder.createProcess("p", "1")
    .addDescription("pDescription")
    .addStringData("d")
    .addDescription("dDescription")
    .addHuman("h")
    .addDescription("hDescription")
    .addHumanTask("t1", "null")
    .addDescription("hDescription")
    .addSystemTask("t2")
    .addDescription("sysDescription")
    .addSubProcess("t3", "null")
    .addDescription("subDescription")
    .addDecisionNode("t4")
    .addDescription("decisionDescription")
    .addTransition("tr", "t1", "t2")
    .addDescription("trDescription")
    .done();
  ...
  public void testManyInstancesConnector() throws BonitaException, IOException {
    ProcessDefinition process = ProcessBuilder.createProcess("p", "1")
    .addIntegerData("data")
    .addSystemTask("t")
    .addConnector(Event.automaticOnEnter, NumberConnector.class.getName(), true)
    .addInputParameter("setNumber", "${data}")
    .done();

    process = getManagementAPI().deploy(getBusinessArchive(process, getResourcesFromConnector(NumberConnector.class), NumberConnector.class));
    ...
    Map<String, Object[]> parameters = getQueryDefinitionAPI().getProcess(processUUID).getActivity("t").getConnectors().iterator().next().getParameters();
    ...
    assertEquals("${data}", getQueryDefinitionAPI().getProcess(processUUID).getActivity("t").getConnectors().iterator().next().getParameters().get("setNumber")[0]);
  ...
  public void testProcessNullVersion() {
    ProcessDefinition definition = ProcessBuilder.createProcess("nullVersion", null).done();
    Assert.assertEquals("1.0", definition.getVersion());
  }

  public void testProcessEmptyVersion() {
    ProcessDefinition definition = ProcessBuilder.createProcess("emptyVersion", "").done();
    Assert.assertEquals("1.0", definition.getVersion());
  }

  public void testProcessWhiteSpaceVersion() {
    ProcessDefinition definition = ProcessBuilder.createProcess("whiteSpacesVersion", "    ").done();
    Assert.assertEquals("1.0", definition.getVersion());
  }

  public void testProcessNullDataName() {
    try {
      ProcessBuilder.createProcess("nullDataName", "")
      .addStringData(null).done();
  ...
  public void testProcessEmptyDataName() {
    try {
      ProcessBuilder.createProcess("emptyDataName", "")
      .addStringData("").done();
  ...
  public void testProcessWhiteSpaceDataName() {
    try {
      ProcessBuilder.createProcess("whiteSpacesDataName", "")
      .addStringData("   ").done();
      fail("The name of the data is empty");
    } catch (Exception e) {
    }
  ...
  public void testProcessNullDataType() {
    ProcessBuilder.createProcess("nullDataType", "")
    .addStringData("car", null).done();
  }

  public void testProcessSystemTaskWithATaskEventConenctor() {
    try {
      ProcessBuilder.createProcess("nullEnumDataName", "")
      .addSystemTask("start")
      .addConnector(Event.taskOnStart, SetVarConnector.class.getName(), true)
      .done();
  ...
  public void testProcessTwoTasksSameName() {
    try {
      ProcessBuilder.createProcess("sameName", "1.0")
      .addSystemTask("start")
      .addSystemTask("start").done();
  ...
  public void testProcessTwoTransitionsSameName() {
    try {
      ...
      .addSystemTask("start")
      .addSystemTask("end")
      .addTransition("go", "start", "system")
      .addTransition("go", "system", "end")
      .done();
  ...
  public void testActivityInstanceLabelAndDescription() throws BonitaException {
    ...
    .addHumanTask("taskName", "group")
    .addLabel("taskLabel")
    .addDescription("taskDescription")
    .done();
  ...
  public void testLabelOnGroup() throws BonitaException {
    ...
    p = ProcessBuilder.createProcess("p", "1")
    .addSystemTask("a")
    .addGroup("group")
    .addLabel("myLabel")
    .addGroupResolver(UserListRoleResolver.class.getName())
    .addInputParameter("setUsers", "john, jack")
    .done();

    ParticipantDefinition group = null;
    for (ParticipantDefinition participant : p.getParticipants()) {
  ...
  public void testProcessVersion() throws BonitaException {
    ProcessDefinition p = ProcessBuilder.createProcess("p", "2.0").addSystemTask("t").done();
    assertEquals("2.0", p.getVersion());
    ProcessDefinition process = getManagementAPI().deploy(getBusinessArchive(p));
  ...
  public void testFirstActivities() throws BonitaException {
    ...
    p = ProcessBuilder.createProcess("p", "1")
    .addSystemTask("a").addSystemTask("b")
    .done();
    ...
    p = ProcessBuilder.createProcess("p", "1")
    .addSystemTask("a").addSystemTask("b").addSystemTask("c")
    .addTransition("a_b", "a", "b")
    .done();
    ...
    p = ProcessBuilder.createProcess("p", "1")
    .addSystemTask("a").addSystemTask("b").addSystemTask("c")
    .addTransition("a_b", "a", "b").addTransition("b_c", "b", "c")
    .done();
    checkInitialActivity(p, "a");

    p = ProcessBuilder.createProcess("p", "1")
    .addSystemTask("a").addSystemTask("b").addSystemTask("c")
    .addTransition("a_b", "a", "b").addTransition("a_c", "a", "c")
    .done();
    checkInitialActivity(p, "a");
  }

  private void checkInitialActivity(ProcessDefinition process, String... expectedActivities) throws BonitaException {
    ...
    ProcessDefinition deployedProcess = getManagementAPI().deploy(getBusinessArchive(process));
  ...
  public void testBAMProcess() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("bam", "1.0")
    .addHuman("john")
    .addHumanTask("bamTask", "john")
    .addActivityExecutingTime(3600)
    .addActivityPriority(1)
    .addSystemTask("bamSystem")
    .addActivityExecutingTime(1000)
    .addActivityPriority(2)
    .addTransition("bamTask", "bamSystem")
    .done();
  ...
  public void testDefaultTransitions() {
    ...
    .setDefault()
    .done();
    Set<TransitionDefinition> transitions = process.getActivity("t1").getOutgoingTransitions();
    TransitionDefinition transition = transitions.iterator().next();
    assertTrue(transition.isDefault());
  }
  
  public void testTwoDefaultTransitionFromTheSameActivity() {
    ProcessBuilder process = ProcessBuilder.createProcess("p", "1.0")
    .addSystemTask("t1")
    .addSystemTask("t2")
    .addSystemTask("t3")
    .addTransition("t1", "t2")
  ...
  public void testAddAnInstantitorWithoutAJoinChecker() {
    try {
      ProcessBuilder.createProcess("crash", "1.0")
      .addSystemTask("ouch")
      .addMultipleActivitiesInstantiator("org.bonitasoft.connectors.SimpleInitiator")
      .done();
  ...
  public void testAddAJoinCheckerWithoutAnInstantitor() {
    try {
      ProcessBuilder.createProcess("crash", "1.0")
      .addSystemTask("ouch")
      .addMultipleActivitiesJoinChecker("org.bonitasoft.connectors.SimpleJoinChecker")
      .done();
      fail("The joinChecker is missing!");
    } catch (BonitaRuntimeException e) {
  ...
  public void testAddMultipleActivities() {
    String joinCheckerClassName = "org.bonitasoft.connectors.SimpleJoinChecker";
    String initiatorClassName = "org.bonitasoft.connectors.SimpleInitiator";

    ProcessDefinition definition =
      ProcessBuilder.createProcess("mulitpleActivities", "1.0")
      .addSystemTask("cool")
      .addMultipleActivitiesInstantiator(initiatorClassName)
      .addInputParameter("field1", 1)
      .addMultipleActivitiesJoinChecker(joinCheckerClassName)
      .done();

    ActivityDefinition activity = definition.getActivity("cool");
    MultiInstantiationDefinition initiator = activity.getMultipleInstancesInstantiator();
    ...
    Map<String, Object[]> parameters = initiator.getParameters();
  ...
  public void testReplaceContext() {
    ...
    String before = "key1=" + BonitaConstants.CONTEXT_PREFIX + "key1" + BonitaConstants.CONTEXT_SUFFIX + ", key2=" + BonitaConstants.CONTEXT_PREFIX + "key2" + BonitaConstants.CONTEXT_SUFFIX;
    String after = ProcessBuilder.resolveWithContext(before, props);

    assertEquals("key1=value1, key2=value2", after);
  }

  public void testContextOnInitialValue() throws Exception {
    ProcessDefinition processWorkingCopy = ProcessBuilder.createProcess("testContext", "0.1")
    .addGroup("initiator")
    .addGroupResolver(InstanceInitiator.class.getName())
    .addStringData("processString", BonitaConstants.CONTEXT_PREFIX + "processStringKey" + BonitaConstants.CONTEXT_SUFFIX)
    .addHumanTask("activity", "initiator")
    .addStringData("activityString", BonitaConstants.CONTEXT_PREFIX + "activityStringKey" + BonitaConstants.CONTEXT_SUFFIX)
    .done();
    ...
    byte[] xmlDefContent = XmlDefExporter.getInstance().createProcessDefinition(processWorkingCopy);
    Misc.getFile(xmlDefFile, xmlDefContent);
    ProcessDefinition definition = ProcessBuilder.createProcessFromXmlDefFile(xmlDefFile.toURL(), context);
    ...
    ActivityInstanceUUID activity = getQueryRuntimeAPI().getOneTask(processInstanceUUID, ActivityState.READY);
  ...
  public void testContextOnConnectorInput() throws Exception {
    ...
    .addHumanTask("activity", "initiator")
    .addConnector(Event.taskOnReady, SetVarConnector.class.getName(), true)
    .addInputParameter("value", BonitaConstants.CONTEXT_PREFIX + "processStringKey" + BonitaConstants.CONTEXT_SUFFIX)
    .addInputParameter("variableName", "processString")
    .done();
  ...
  public void testContextOnConnectorInputWithMissingProperty() throws Exception {
    ...
    assertEquals(BonitaConstants.CONTEXT_PREFIX + "processStringKey" + BonitaConstants.CONTEXT_SUFFIX, getQueryRuntimeAPI().getVariable(activity, "processString"));
  ...
  public void testAddBoundaryEvents() throws Exception {
    ProcessDefinition definition = ProcessBuilder.createProcess("events", "0.1")
    .addHuman(getLogin())
    .addHumanTask("step1", getLogin())
      .addLabel("The step label")
      .addDescription("description:activity")
      .addTimerBoundaryEvent("In_5_seconds", "5000")
        .addDescription("description:seconds")
        .addLabel("In 5 seconds")
      .addTimerBoundaryEvent("In_a_minute", "60000")
        .addDescription("description:minute")
        .addLabel("In a minute")
  ...
  public void testAddErrorBoundaryEvents() throws Exception {
    ...
    .addHumanTask("step1", getLogin())
      .addLabel("The step label")
      .addDescription("description:activity")
      .addErrorBoundaryEvent("Cancel_rent", "cancelRent")
        .addDescription("description:The rent was cancelled.")
        .addLabel("Cancel_rent")
      .addErrorBoundaryEvent("Crash_system")
        .addDescription("description:all other errors")
        .addLabel("Crash")
    .addHumanTask("normalStep", getLogin())
    .addHumanTask("cancelStep", getLogin())
    .addHumanTask("crashStep", getLogin())
    .addTransition("step1", "normalStep")
    .addExceptionTransition("step1", "Cancel_rent", "cancelStep")
    .addExceptionTransition("step1", "Crash_system", "crashStep")
    .done();
  ...
  public void testAddBoundaryEventsWithAnUnknwonTransition() throws Exception {
    ProcessBuilder builder = ProcessBuilder.createProcess("events", "0.1")
    .addHuman(getLogin())
    .addHumanTask("step1", getLogin())
      .addLabel("The step label")
      .addDescription("description:activity")
      .addTimerBoundaryEvent("In_5_seconds", "5000")
        .addDescription("description:seconds")
        .addLabel("In 5 seconds")
      .addTimerBoundaryEvent("In_4_seconds", "4000")
        .addDescription("description:minute")
        .addLabel("In a minute")
    .addHumanTask("normalStep", getLogin())
    .addHumanTask("exceptionStep", getLogin())
  ...
  public void testAddBoundaryEventsWithTheSameName() throws Exception {
    ...
    .addHumanTask("step1", getLogin())
      ...
      .addTimerBoundaryEvent("In_5_seconds", "5000")
        .addDescription("description:seconds")
        .addLabel("In 5 seconds")
      .addTimerBoundaryEvent("In_5_seconds", "60000")
        .addDescription("description:minute")
        .addLabel("In a minute")
    .addHumanTask("normalStep", getLogin())
    .addHumanTask("exceptionStep", getLogin())
  ...
  public void testConditionTransitionExceptionTransitionWithAnotherTransition() {
    ProcessBuilder builder = 
      ProcessBuilder.createProcess("events", "0.1")
      .addHuman(getLogin())
      .addHumanTask("step1", getLogin())
        .addTimerBoundaryEvent("In_5_seconds", "5000")
      .addHumanTask("normalStep", getLogin())
  ...
  public void testErrorBoundaryEventOnATask() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addSystemTask("task")
        .addErrorBoundaryEvent("error")
      .addSystemTask("error")
      .addExceptionTransition("task", "error", "error")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testTimerBoundaryEventOnATask() {
    try {
      ...
      .addExceptionTransition("task", "over", "overdue")
      .done();
  ...
  public void testSignalBoundaryEventOnATask() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addSystemTask("task")
        .addSignalBoundaryEvent("signal", "broadcast")
      .addSystemTask("overdue")
      .addExceptionTransition("task", "signal", "overdue")
      .done();
  ...
  public void testMessageBoundaryEventOnATask() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addSystemTask("task")
        .addMessageBoundaryEvent("message", "message")
      .addSystemTask("overdue")
      .addExceptionTransition("task", "message", "overdue")
      .done();
  ...
  public void testErrorBoundaryEventOnASubProcess() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addSubProcess("subProcess", "rent")
        .addErrorBoundaryEvent("error")
      .addSystemTask("error")
      .addExceptionTransition("subProcess", "error", "error")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testTimerBoundaryEventOnASubProcess() {
    try {
      ...
      .addSubProcess("subProcess", "rent")
        .addTimerBoundaryEvent("over", "5000")
      .addSystemTask("overdue")
      .addExceptionTransition("subProcess", "over", "overdue")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testSignalBoundaryEventOnASubProcess() {
    try {
      ...
      .addSubProcess("subProcess", "rent")
        .addSignalBoundaryEvent("signal", "broadcast")
      .addSystemTask("overdue")
      .addExceptionTransition("subProcess", "signal", "overdue")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testMessageBoundaryEventOnASubProcess() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addSubProcess("subPorcess", "rent")
        .addMessageBoundaryEvent("message", "message")
      .addSystemTask("overdue")
      .addExceptionTransition("subPorcess", "message", "overdue")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testErrorBoundaryEventOnASendTask() {
    try {
      ...
      .addSendEventTask("send")
        .addErrorBoundaryEvent("error")
      .addSystemTask("error")
      .addExceptionTransition("send", "error", "error")
      .done();
  ...
  public void testTimerBoundaryEventOnASendTask() {
    try {
      ...
      .addSendEventTask("send")
        .addTimerBoundaryEvent("over", "5000")
      .addSystemTask("overdue")
      .addExceptionTransition("send", "over", "overdue")
      .done();
  ...
  public void testSignalBoundaryEventOnASendTask() {
    try {
      ...
      .addSendEventTask("send")
        .addSignalBoundaryEvent("signal", "broadcast")
      .addSystemTask("overdue")
      .addExceptionTransition("send", "signal", "overdue")
      .done();
  ...
  public void testMessageBoundaryEventOnASendTask() {
    try {
      ...
      .addSendEventTask("send")
        .addMessageBoundaryEvent("message", "message")
      .addSystemTask("overdue")
      .addExceptionTransition("send", "message", "overdue")
      .done();
  ...
  public void testErrorBoundaryEventOnATimer() {
    try {
      ProcessBuilder.createProcess("bndrvnts", "1.4")
      .addTimerTask("timer", "5000")
        .addErrorBoundaryEvent("error")
      .addSystemTask("error")
      .addExceptionTransition("timer", "error", "error")
      .done();
      fail("An error boundary event cannot be added on a send task");
    } catch (BonitaRuntimeException e) {
    }
  ...
  public void testTimerBoundaryEventOnATimer() {
    try {
      ...
      .addTimerTask("timer", "5000")
        .addTimerBoundaryEvent("over", "5000")
      .addSystemTask("overdue")
      .addExceptionTransition("timer", "over", "overdue")
      .done();
      fail("A timer boundary event cannot be added on a send task");
    } catch (BonitaRuntimeException e) {
    }
  ...
  public void testSignalBoundaryEventOnATimer() {
    try {
      ...
      .addTimerTask("timer", "5000")
        .addSignalBoundaryEvent("signal", "broadcast")
      .addSystemTask("overdue")
      .addExceptionTransition("timer", "signal", "overdue")
      .done();
      fail("A signal boundary event cannot be added on a send task");
    } catch (BonitaRuntimeException e) {
    }
  ...
  public void testMessageBoundaryEventOnATimer() {
    try {
      ...
      .addTimerTask("timer", "5000")
        .addMessageBoundaryEvent("message", "message")
      .addSystemTask("overdue")
      .addExceptionTransition("timer", "message", "overdue")
      .done();
  ...
  public void testErrorBoundaryEventOnAGate() {
    try {
      ...
      .addDecisionNode("gate")
        .addErrorBoundaryEvent("error")
      .addSystemTask("error")
      .addExceptionTransition("gate", "error", "error")
      .done();
    } catch (BonitaRuntimeException e) {
  ...
  public void testTimerBoundaryEventOnAGate() {
    try {
      ...
      .addDecisionNode("gate")
        .addTimerBoundaryEvent("over", "5000")
      .addSystemTask("overdue")
      .addExceptionTransition("gate", "over", "overdue")
      .done();
  ...
  public void testSignalBoundaryEventOnAGate() {
    try {
      ...
      .addDecisionNode("gate")
        .addSignalBoundaryEvent("signal", "broadcast")
      .addSystemTask("overdue")
      .addExceptionTransition("gate", "signal", "overdue")
      .done();
  ...
  public void testMessageBoundaryEventOnAGate() {
    try {
      ...
      .addDecisionNode("gate")
        .addMessageBoundaryEvent("message", "message")
      .addSystemTask("overdue")
      .addExceptionTransition("gate", "message", "overdue")
      .done();
  ...
  public void testEventSubProcessWithAHumanTask() {
    try {
      ProcessBuilder.createProcess("vntSbPrcss", "1.0")
      .setEventSubProcess()
      .addHuman(getLogin())
  ...
  public void testEventSubProcessWithStartTasks() {
    try {
      ...
      .setEventSubProcess()
      .addHuman(getLogin())
      .addHumanTask("start1", getLogin())
      .addHumanTask("start2", getLogin())
      .addHumanTask("next", getLogin())
      .addTransition("start1", "next")
      .addTransition("start2", "next")
      .done();
      fail("An event sub-process must start with a start event");
    } catch (BonitaRuntimeException e) {
    }
  ...
  public void testEventSubProcessWithAStartEvent() {
    ProcessBuilder.createProcess("vntSbPrcss", "1.0")
      .setEventSubProcess()
      .addTimerTask("In_a_minute", "60000")
      .done();
  }
  ...
  public void testSetTransient() {
    ...
    Set<DataFieldDefinition> dataFields = process.getActivity("activityWithTransientData").getDataFields();
  ...
  public void testSetProcessVariableTransient() {
    try {
      ProcessBuilder.createProcess("prcssWithTransientData", "1.0")
        .addStringData("transient")
            .setTransient()
        .done();
  ...
  public void testAddAttachmentAndVariableWithIdenticalName() {
	  try {
		  ProcessBuilder.createProcess("pav", "2.0")
		    .addAttachment("a")
		    .addStringData("a")
		    .addHuman(getLogin())
