...
public abstract class DroolsCommandConnector extends DroolsConnector {
  ...
  /* (non-Javadoc)
   * @see org.bonitasoft.connectors.drools.common.DroolsConnector#getRequest()
   */
  @Override
  protected String getRequest() {
    List<Command> cmds = new ArrayList<Command>();
    Command command = getSpecifiedCommand();
    if(command!=null){
      cmds.add(command);
    }
    FireAllRulesCommand fireAllRulesCommand = new FireAllRulesCommand();
    cmds.add(fireAllRulesCommand);
    BatchExecutionCommand batchExecutionCommand = CommandFactory.newBatchExecution(cmds, ksessionName);
  ...
  /* (non-Javadoc)
   * @see org.bonitasoft.connectors.drools.common.DroolsConnector#validateExtraParams()
   */
  @Override
  protected List<ConnectorError> validateExtraParams() {
    ...
    ConnectorError ksessionNameEmptyError = this.getErrorIfNullOrEmptyParam(ksessionName, "ksessionName");
