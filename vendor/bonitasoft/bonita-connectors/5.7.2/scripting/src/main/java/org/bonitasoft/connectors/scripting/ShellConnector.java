...
public class ShellConnector extends AbstractShellConnector {
  ...
  protected List<ConnectorError> validateValues() {
    ...
    if ("".equals(shell.trim())) {
      ConnectorError error = new ConnectorError("shell", new IllegalArgumentException(
      "is empty"));
      errors.add(error);
    }
    return errors;
  ...
  /* (non-Javadoc)
   * @see org.bonitasoft.connectors.scripting.AbstractShellConnector#executeShellCommand()
   */
  @Override
