...
public class EmailConnectorTest extends TestCase {
  ...
  protected void setUp() throws Exception {
    ...
    if (EmailConnectorTest.LOG.isLoggable(Level.WARNING)) {
      EmailConnectorTest.LOG.warning("======== Starting test: " + this.getClass().getName() + "." + this.getName() + "() ==========");
    }
  }
  ...
  protected void tearDown() throws Exception {
    if (EmailConnectorTest.LOG.isLoggable(Level.WARNING)) {
      EmailConnectorTest.LOG.warning("======== Ending test: " + this.getName() + " ==========");
    }
    super.tearDown();
  }

  public void testValidateConnector() throws BonitaException {
    List<ConnectorError> errors = Connector.validateConnector(EmailConnector.class);
  ...
  public void testSetPassword() throws BonitaException {
    ...
    email.setUserName("");
    email.setPassword(null);
    List<ConnectorError> validate = email.validate();
  ...
  public void testSendEmailWithAttachments() throws Exception {
    try {
      ...
      Multipart m = (Multipart) mime.getContent();
  ...
  private ArrayList<Object> getBasicAttachments() {
    URL xml = EmailConnector.class.getResource(XML_FILE);
