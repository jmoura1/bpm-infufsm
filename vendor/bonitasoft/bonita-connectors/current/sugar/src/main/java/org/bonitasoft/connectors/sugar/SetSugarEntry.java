...
public class SetSugarEntry extends SugarCrmSoapClient {
    ...
    protected List<ConnectorError> validateValues() {
        ...
        if (nameValueList == null || nameValueList.length == 0) {
            errors.add(new ConnectorError("nameValueList", new IllegalArgumentException("Cannot be empty. Must have a name-value attribute!")));
        }
        try {
    ...
    protected void executeConnector() throws Exception {
        returnedId = this.setEntry(module, nameValueList);
    }
     ...
     * set the module
     * 
     * @param module the SugarCRM module
     */
     ...
     * 
     * @param nameValueList the name value list
     */
     ...
     * set the nameValueList
     * 
     * @param nameValueArrayList the name value array list
     */
    public void setNameValueList(final List<List<Object>> nameValueArrayList) {
        // Transform List to Name_value[]
        this.nameValueList = convertToNameValue(nameValueArrayList);
    }
