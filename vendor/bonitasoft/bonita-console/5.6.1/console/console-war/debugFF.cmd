@echo off
set BONITATARGETVERSION=5.6.1-SNAPSHOT
set CONSOLETARGETVERSION=5.6.1-SNAPSHOT

set WORKSPACEPATH=%CD%\..\..\..
set PATHTOPROJECT=%WORKSPACEPATH%\bonita-console-5.6.x
set MAVENREPOPATH=%USERPROFILE%\.m2\repository
set BONITA_HOME=%PATHTOPROJECT%\distrib\target\BOS-%CONSOLETARGETVERSION%-deploy\conf\bonita
set EXTERNAL_FOLDER=%PATHTOPROJECT%\distrib\target\BOS-%CONSOLETARGETVERSION%-deploy\conf\external
