...
public class FormValidator implements Serializable {
     ...
     * @param label validator label
     * @param style validator label CSS classNames
     */
    public FormValidator(final String id, final String validatorClass, final String label, final String style) {
        this.id = id;
     ...
     * @param parameter
     */
    public FormValidator(final String id, final String validatorClass, final String label, final String style, final String parameter) {
        this.id = id;
        this.validatorClass = validatorClass;
        this.label = label;
        this.style = style;
