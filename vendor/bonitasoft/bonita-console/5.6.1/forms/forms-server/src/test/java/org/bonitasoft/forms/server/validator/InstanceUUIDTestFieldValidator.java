 ...
 *
 */
public class InstanceUUIDTestFieldValidator extends AbstractFormValidator implements IFormFieldValidator {
    ...
    public boolean validate(FormFieldValue fieldInput, Locale locale) {
        if (getProcessInstanceUUID() != null && getProcessInstanceUUID().getValue().equals(fieldInput.getValue())) {
            return true;
        }
        return false;
    }
