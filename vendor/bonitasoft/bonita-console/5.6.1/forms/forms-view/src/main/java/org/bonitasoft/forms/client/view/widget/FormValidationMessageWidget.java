...
public class FormValidationMessageWidget extends Composite {
     ...
     */
    public FormValidationMessageWidget(final FormValidator formValidatorData, final boolean isPageValidation) {
     ...
     */
    protected void createWidget(final FormValidator formValidatorData) {
     ...
     * @return
     */
    protected String getValidatorLabel(final FormValidator formValidatorData) {
