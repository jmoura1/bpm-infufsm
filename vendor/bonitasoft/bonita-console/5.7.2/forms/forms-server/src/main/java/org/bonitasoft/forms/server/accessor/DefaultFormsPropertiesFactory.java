...
public class DefaultFormsPropertiesFactory {
    ...
    private static Map<String, DefaultFormsProperties> map = new HashMap<String, DefaultFormsProperties>();

    /**
     * Get domain DefaultFormsProperties
     * @return DefaultFormsProperties 
     */
    public static DefaultFormsProperties getDefaultFormProperties() {
        final String domain = ThreadLocalManager.getDomain();
        if (!map.containsKey(domain)) {
            map.put(domain, new DefaultFormsProperties());
        }
