...
public class FormServiceProviderFactory {
    ...
    public static FormServiceProvider getFormServiceProvider() throws FormServiceProviderNotFoundException {
        FormServiceProvider formServiceProvider = null;
        String formServiceProviderName = null;
        try {
            formServiceProviderName = DefaultFormsPropertiesFactory.getDefaultFormProperties().getFormServiceProviderImpl();
