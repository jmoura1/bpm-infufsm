...
CATALINA_OPTS="$CATALINA_OPTS $BONITA_HOME $SECURITY_OPTS $CMIS_CONFIG -Dfile.encoding=UTF-8 -Xshare:auto -Xms512m -Xmx1024m -XX:MaxPermSize=256m -XX:+HeapDumpOnOutOfMemoryError"
