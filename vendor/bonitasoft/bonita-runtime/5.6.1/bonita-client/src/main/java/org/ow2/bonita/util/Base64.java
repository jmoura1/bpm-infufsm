...
public final class Base64 {
  ...
  private static int decode4to3(byte[] source, int srcOffset,
    ...
    byte[] decodeabet = getDecodabet(options);
    ...
    if (source[srcOffset + 2] == EQUALS_SIGN) {
      ...
      int outBuff = ((decodeabet[source[srcOffset]] & 0xFF) << 18)
      ...
      try {
        ...
        System.out.println("" + source[srcOffset] + ": "
            + (decodeabet[source[srcOffset]]));
        System.out.println("" + source[srcOffset + 1] + ": "
            + (decodeabet[source[srcOffset + 1]]));
        System.out.println("" + source[srcOffset + 2] + ": "
            + (decodeabet[source[srcOffset + 2]]));
        System.out.println("" + source[srcOffset + 3] + ": "
            + (decodeabet[source[srcOffset + 3]]));
        return -1;
      } // end catch
    }
  } // end decodeToBytes
  ...
  public static class InputStream extends java.io.FilterInputStream {
    ...
    public int read() throws java.io.IOException {
        ...
        if (encode) {
          ...
          if (i == 4) {
            ...
            // Must have broken out from above.
          	String message = ExceptionManager.getInstance().getFullMessage("buc_B64_1");
      ...
      String message = ExceptionManager.getInstance().getFullMessage("buc_B64_2");
      ...
      if (encode) {
        ...
        if (decodabet[theByte & 0x7f] > WHITE_SPACE_ENC) {
          ...
          if (position >= bufferLength) { // Enough to output.
        	...
        	String message = ExceptionManager.getInstance().getFullMessage("buc_B64_3");
          throw new java.io.IOException(message);
      ...
      if (position > 0) {
        if (encode) {
          ...
          // end if: encoding
        	...
        	String message = ExceptionManager.getInstance().getFullMessage("buc_B64_4");
          throw new java.io.IOException(message);
        } // end else: decoding
