 ...
 * code objects in a persistable way. {@link ExternalActivity}s and
 * {@link org.ow2.bonita.definition.activity.ExternalActivity} and other user code can
 ...
 * <li><b>{@link PropertyOperation}</b>: injects another object with a setter
 * method.</li>
 * <li><b>{@link InvokeOperation}</b>: invokes a method.</li>
 * <li><b>{@link SubscribeOperation}</b>: subscribes to an {@link Observable
 * observable}.</li>
 * </ul>
 * 
 * <h3>Environment</h3>
 ...
 * <ul>
 * <li>{@link AbstractDescriptor#INIT_LAZY}: for lazy creation and delayed
 * initialization</li>
 * <li>{@link AbstractDescriptor#INIT_REQUIRED}: for lazy creation and immediate
 * initialization</li>
 * <li>{@link AbstractDescriptor#INIT_EAGER}: for eager creation and delayed
 * initialization</li>
 * <li>{@link AbstractDescriptor#INIT_IMMEDIATE}: for eager creation and
...
public class WireContext extends DefaultObservable implements Context,
  ...
  void processPendingInitializations() {
    if (pendingInitializations != null) {
      Collection<PendingInitialization> pendingInitializationValues = new HashSet<PendingInitialization>(
