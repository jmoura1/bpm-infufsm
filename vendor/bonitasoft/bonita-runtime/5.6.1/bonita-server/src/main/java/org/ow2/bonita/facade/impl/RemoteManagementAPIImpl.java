...
public class RemoteManagementAPIImpl extends AbstractRemoteManagementAPIImpl implements RemoteManagementAPI {
  ...
  public void archive(Collection<ProcessDefinitionUUID> processUUIDs, final Map<String, String> options)
      throws DeploymentException, RemoteException {
    getAPI(options).archive(processUUIDs);
  }

  public void delete(Collection<ProcessDefinitionUUID> processUUIDs, final Map<String, String> options)
  ...
  public void disable(Collection<ProcessDefinitionUUID> processUUIDs, final Map<String, String> options)
      throws DeploymentException, RemoteException {
    getAPI(options).disable(processUUIDs);
  }

  public void enable(Collection<ProcessDefinitionUUID> processUUIDs, final Map<String, String> options)
      throws DeploymentException, RemoteException {
  ...
  public List<Rule> getAllApplicableRules(final String userUUID, final Collection<String> roleUUIDs, final Collection<String> groupUUIDs,
      final Collection<String> membershipUUIDs, final String entityID, final Map<String, String> options) throws RemoteException {
  ...
  public List<Rule> getApplicableRules(final RuleType ruleType, final String userUUID, final Collection<String> roleUUIDs,
      final Collection<String> groupUUIDs, final Collection<String> membershipUUIDs, final String entityID, final Map<String, String> options)
