...
public interface JvmMBean {
    ...
    /**
     * Returns the percentage of memory used compare to maximum available memory. This calculation is based on both the heap &
     * non-heap maximum amount of memory that can be used.
     */
    ...
    /**
     * Returns a timestamp (in millisecond) which indicates the date when the Java virtual machine started. Usually, a timestamp
     * represents the time elapsed since the 1st of January, 1970.
     */
    public long getStartTime();

    /**
     * Returns the total CPU time for all live threads in nanoseconds. It sums the CPU time consumed by each live threads.
     */
