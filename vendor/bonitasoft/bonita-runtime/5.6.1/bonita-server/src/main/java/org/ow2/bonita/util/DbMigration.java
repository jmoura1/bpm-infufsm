...
public final class DbMigration {
   ...
   */
  public static void migrateDb(final String domain, final String configurationName, final String db, final String currentVersion,
  ...
  public static InputStream findMigrationScript(final String db, final String currentVersion, final String targetVersion) {
    ...
    migrationScript.append("/migration/").append(db).append("-").append(currentVersion).append("-").append(
        targetVersion).append(".sql");
  ...
  public static void main(final String[] args) throws Exception {
    ...
    final String targetVersion = "5.6.1";
