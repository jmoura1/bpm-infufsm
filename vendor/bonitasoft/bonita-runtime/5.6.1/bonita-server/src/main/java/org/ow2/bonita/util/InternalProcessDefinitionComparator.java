...
public class InternalProcessDefinitionComparator implements Comparator<InternalProcessDefinition> {
  ...
  public int compare(InternalProcessDefinition o1, InternalProcessDefinition o2) {
    switch (this.pagingCriterion) {
      case NAME_ASC: return o1.getName().compareTo(o2.getName());
      ...
      case VERSION_ASC: return o1.getVersion().compareTo(o2.getVersion());

      case STATE_ASC: return o1.getState().toString().compareTo(o2.getState().toString());

      case NAME_DESC: return o2.getName().compareTo(o1.getName());
      ...
      case VERSION_DESC: return o2.getVersion().compareTo(o1.getVersion());

      case STATE_DESC: return o2.getState().toString().compareTo(o1.getState().toString());

      case DEFAULT: o1.getLabelOrName().compareTo(o2.getLabelOrName());
    }
    return 0;
  }
