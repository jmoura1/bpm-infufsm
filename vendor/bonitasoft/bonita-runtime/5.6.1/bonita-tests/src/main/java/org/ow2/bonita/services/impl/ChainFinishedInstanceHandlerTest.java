...
import org.ow2.bonita.CMISEnvGenerator;
...
public class ChainFinishedInstanceHandlerTest extends
    APITestCase {
  ...
  public static EnvGenerator getEnvGenerator() {
    final EnvGenerator envGenerator = new CMISEnvGenerator();
    envGenerator.addApplicationEntry(EnvGenerator.getChainerEnvEntry(FinishedInstanceHandler.DEFAULT_KEY, "", true, DeleteFinishedInstanceHandler.class, TestFinishedInstanceHandler.class));
    return envGenerator;
  }
