...
/**
 * main parser. It parses the <code>contexts</code>, which is assumed the document element and can contain the
 * {@link EnvironmentFactoryXmlParser environment-factory} context and the {@link EnvironmentXmlParser environment}
 * context.
 * 
