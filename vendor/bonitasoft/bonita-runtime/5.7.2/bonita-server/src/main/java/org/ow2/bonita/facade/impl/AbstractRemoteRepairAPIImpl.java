...
public class AbstractRemoteRepairAPIImpl implements AbstractRemoteRepairAPI {
  ...
  public ActivityInstanceUUID startExecution(ProcessInstanceUUID instanceUUID, String activityName, final Map<String, String> options)
  ...
  public void stopExecution(ProcessInstanceUUID instanceUUID, String activityName, final Map<String, String> options) throws RemoteException,
