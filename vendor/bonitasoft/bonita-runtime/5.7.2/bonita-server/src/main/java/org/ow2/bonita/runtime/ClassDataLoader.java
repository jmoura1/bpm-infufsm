...
/**
 * This class must be in the environment for multi tenancy reasons (else the map of processes will generate conflicts between two processes
 * with the same UUID in two different tenants.
 *
 */
public final class ClassDataLoader {
  ...
  public <T> T getInstance(final Class<T> clazz, final ProcessDefinitionUUID processUUID, final ConnectorDefinition connector) {
