...
public class ExecuteStandaloneConnectorTest extends APITestCase {
  ...
  public void testExecuteFilterWithParameters() throws Exception {
    ...
    final Set<String> candidates = getRuntimeAPI().executeFilter(RandomMultipleFilter.class.getName(), parameters, members);
  ...
  public void testExecuteGroovyConnectorWithAProcessDefinition() throws Exception {
    ...
    final Map<String, Object[]> parameters = new HashMap<String, Object[]>();
    parameters.put("script", new Object[] {"45"});
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, definition.getUUID());
    final Map<String, Object> expected = new HashMap<String, Object>();
    expected.put("result", 45);
    assertEquals(expected, actual);
  ...
  public void testExecuteGroovyConnectorWithAProcessDefinitionAndAContext() throws Exception {
    ...
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, definition.getUUID(), context);
    final Map<String, Object> expected = new HashMap<String, Object>();
  ...
  public void testExecuteConnectorsWithProcessDefinitionAndContext() throws Exception {
    ...
    ProcessDefinition definition =
        ProcessBuilder.createProcess("p1", "1.0")
        .addHuman(getLogin())
    ...
    final ConnectorExecutionDescriptor connectorExecutionDescriptor1 = new ConnectorExecutionDescriptor(connectorClass.getName());
    connectorExecutionDescriptor1.addInputParameter("script", "${\"List<String> l = new ArrayList<String>(); l.add(\\\"\" + field1 + \"\\\" + \\\" updated\\\"); l.add(\\\"second element\\\"); return l;\"}");
    ...
    final ConnectorExecutionDescriptor connectorExecutionDescriptor2 = new ConnectorExecutionDescriptor(connectorClass.getName());
    connectorExecutionDescriptor2.addInputParameter("script", "${\"List<String> l = new ArrayList<String>(); l.add(\\\"\" + field1 + \"\\\"); l.add(\\\"\" + field2 + \"\\\"); l.add(\\\"third element\\\"); return l;\"}");
    ...
    final Map<String, Object> actual = getRuntimeAPI().executeConnectors(definition.getUUID(), connectorsExecDesc, context);
  ...
  public void testExecuteConnectorsOptionDoesntThrowException() throws Exception {
    ...
    ProcessDefinition definition =
        ...
        .addHumanTask("step1", getLogin())
        .done();
    definition = getManagementAPI().deploy(getBusinessArchive(definition, getResourcesFromConnector(connectorClass), connectorClass, errorConnectorClass));
    ...
    ConnectorExecutionDescriptor erroConnectorDesc = new ConnectorExecutionDescriptor(errorConnectorClass.getName());
  ...
  public void testExecuteConnectorsWithProcessInstanceAndContext() throws Exception {
    ...
    ProcessDefinition definition = ProcessBuilder.createProcess("p1", "1.0").addStringData("var1", "process variable")
        .addObjectData("list", ArrayList.class.getName(), new ArrayList<String>()).addHuman(getLogin()).addHumanTask("step1", getLogin()).done();
    definition = getManagementAPI().deploy(getBusinessArchive(definition, getResourcesFromConnector(connectorClass), connectorClass));
    ...
    final ConnectorExecutionDescriptor connectorExecutionDescriptor1 = new ConnectorExecutionDescriptor(connectorClass.getName());
    connectorExecutionDescriptor1.addInputParameter("script",
        "${\"List<String> l = new ArrayList<String>(); l.add(\\\"\" + field1 + \"\\\" + \\\" updated\\\"); l.add(\\\"second element\\\"); return l;\"}");
    connectorExecutionDescriptor1.addOutputParameter("field1", "${result.get(0)}");
    connectorExecutionDescriptor1.addOutputParameter("field2", "${result.get(1)}");

    final ConnectorExecutionDescriptor connectorExecutionDescriptor2 = new ConnectorExecutionDescriptor(connectorClass.getName());
    connectorExecutionDescriptor2.addInputParameter("script",
    ...
    final Map<String, Object> actual = getRuntimeAPI().executeConnectors(processInstanceUUID, connectorsExecDesc, context, false);
    final List<String> result = (List<String>) actual.get("result");
    assertNotNull(result);
    assertEquals(3, result.size());
    assertEquals("first element updated", result.get(0));
    ...
    final List<String> list = (List<String>) getQueryRuntimeAPI().getProcessInstanceVariable(processInstanceUUID, "list");
  ...
  public void testExecuteConnectorsWithActivityInstanceAndContext() throws Exception {
    ...
    ProcessDefinition definition = ProcessBuilder.createProcess("p1", "1.0")
        .addHuman(getLogin())
        .addHumanTask("step1", getLogin())
          .addObjectData("list", ArrayList.class.getName(), new ArrayList<String>())
          .addStringData("var1", "activity variable")
        .done();
    definition = getManagementAPI().deploy(getBusinessArchive(definition, getResourcesFromConnector(connectorClass), connectorClass));
    ...
    final Set<ActivityInstance> activityInstances = getQueryRuntimeAPI().getActivityInstances(processInstanceUUID, "step1");
    final ActivityInstance activityInstance = activityInstances.iterator().next();

    final Map<String, Object> actual = getRuntimeAPI().executeConnectors(activityInstance.getUUID(), connectorsExecDesc, context, false);
    final List<String> result = (List<String>) actual.get("result");
    assertNotNull(result);
    assertEquals(3, result.size());
    assertEquals("first element updated", result.get(0));
    ...
    final List<String> list = (List<String>) getQueryRuntimeAPI().getActivityInstanceVariable(activityInstance.getUUID(), "list");
    assertEquals(3, list.size());
  ...
  public void testExecuteRoleResolverWithAProcessDefinition() throws Exception {
    ...
    final Set<String> members = getRuntimeAPI().executeRoleResolver(connectorClass.getName(), parameters, definition.getUUID());
    assertTrue(members.contains("john"));
    assertTrue(members.contains("jack"));
    assertTrue(members.contains("joe"));
    assertTrue(members.contains("jane"));
  ...
  public void testExecuteFilterWithAProcessDefinition() throws Exception {
    ...
    members.add("jane");
    members.add("joe");
    final Set<String> candidates = getRuntimeAPI().executeFilter(connectorClass.getName(), null, members, definition.getUUID());
    assertEquals(1, candidates.size());
    final String candidate = candidates.iterator().next();
    assertTrue(members.contains(candidate));
  ...
  public void testExecuteGroovyConnectorWithAProcessInstance() throws Exception {
    ...
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, processInstanceUUID, context, false);
    final Map<String, Object> expected = new HashMap<String, Object>();
  ...
  public void testExecuteGroovyConnectorWithAProcessInstanceUsingCurrentProcessValues() throws Exception {
    ...
    final Map<String, Object[]> parameters = new HashMap<String, Object[]>();
    parameters.put("script", new Object[] {"${field1 + \"45 + \" + processVar}"});
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, processInstanceUUID, context, true);
    final Map<String, Object> expected = new HashMap<String, Object>();
  ...
  public void testExecuteGroovyConnectorWithAnActivityInstance() throws Exception {
    ...
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, activityInstanceUUID, context, false);
    final Map<String, Object> expected = new HashMap<String, Object>();
  ...
  public void testExecuteGroovyConnectorWithAnActivityInstanceUsingCurrentProcessValues() throws Exception {
    ...
    final Map<String, Object[]> parameters = new HashMap<String, Object[]>();
    parameters.put("script", new Object[] {"${field1 + \"45 + \" + processVar + \" + \" + activityVar}"});
    final Map<String, Object> actual = getRuntimeAPI().executeConnector(connectorClass.getName(), parameters, activityInstanceUUID, context, true);
    final Map<String, Object> expected = new HashMap<String, Object>();
