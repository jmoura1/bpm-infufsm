...
public class MultiTenancyTest extends TestCase {
  ...
  public void testProcessClassLoader() throws Exception {
    ...
    ProcessDefinition process = ProcessBuilder.createProcess("classloader", "1.0")
  ...
  public void testCommonClassLoader() throws Exception {
    ...
    loginContext = login(TENANT1_ID);
    try {managementAPI.removeJar("tenant.jar");} catch (Exception e) {}
  ...
  public static Map<String, byte[]> getJarFile(final String jarFileName, final String className, final String base) throws Exception {
    ...
    byte[] jar = Misc.generateJar(resources);
    resources.clear();
  ...
  public static BusinessArchive getBusinessArchive() throws Exception {
    ProcessDefinition process = ProcessBuilder.createProcess("testMultiTenancy", "0.1")
  ...
  public static void waitForInstanceEnd(long maxWait, long sleepTime, ProcessInstanceUUID instanceUUID) throws BonitaException {
  ...
  public static void waitForCreation(final long maxWait, final int expected, final ProcessDefinitionUUID createdUUID) throws Exception {
    ...
    int size = AccessorUtil.getQueryRuntimeAPI().getLightProcessInstances(createdUUID).size();
  ...
  public void testSearchError() throws Exception {
    ...
    try {
      ...
      e.printStackTrace();
      assertTrue(e.getMessage().contains("Hibernate Search Event listeners not configured"));
    }
